...
При создании электрошкафов серии Rittal 'TS8', 'AE' и 'CM', которые были импортированы в [пространство листа](Glossary_o_bauraum.md) в виде файлов STEP, существует возможность автоматического размещения исходных точек в соответствии с серией электрошкафа.

Условия:

* Вы открыли проект макросов.
* Навигатор пространства листов открыт, и одно пространство листов открыто.
* Пространство листа содержит импортированную трехмерную графику, которую необходимо [сохранить](Glossary_o_einlagern.md) в качестве электрошкафа.
* Четыре боковых вертикальных профиля, а также верхний и нижний [профиль](Glossary_o_verlauf.md) имеют соответствующее определение [функции](Glossary_o_funktionen.md) и обозначение функциональных элементов.
