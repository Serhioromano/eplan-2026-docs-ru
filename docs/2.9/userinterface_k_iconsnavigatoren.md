...
Если в представлениях в виде дерева навигаторов данных проекта навести курсор на пиктограмму, можно будет увидеть краткий текст с информацией про эту пиктограмму (всплывающая подсказка). Если [пиктограммы](Glossary_o_icons.md) объединены (например, ![](images/navigatorgui_mainfunctionpart_as.png){: .ui-icon }![](images/navigatorgui_function_as.png){: .ui-icon } для размещенной многополюсной главной [функции](Glossary_o_funktionen.md)), то для каждой пиктограммы будет отображаться отдельная всплывающая подсказка.
...
![](images/navigatorgui_insulation_as.png){: .ui-icon } |  Изолированный конец [соединения](Glossary_o_verbindungen.md)
...
* В навигаторах для отображения устройств все [устройства](Glossary_o_betriebsmittel.md), которые имеют только обозначение устройства, но не структурные идентификаторы, такие как [установка](Glossary_o_anlage.md), [место установки](Glossary_o_einbauort.md) и т. д., на уровне структуры дерева сортируются ![](images/navigatorgui_device_as.png){: .ui-icon } ***без структурных идентификаторов***. Все устройства, которые имеют собственное ОУ, на уровне структуры дерева сортируются ![](images/navigatorgui_device_as.png){: .ui-icon } ***без ОУ***.
