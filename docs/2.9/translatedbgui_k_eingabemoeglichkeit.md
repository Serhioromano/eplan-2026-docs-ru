...
В словарь можно включать [ключевые слова](Glossary_o_stichworte.md) в виде отдельных слов, ключевые слова в виде предложений и ключевые слова с заполнителями.
...
Это обозначение для многозначных текстов задается в соответствующем поле с помощью пункта всплывающего меню Обозначить текст, не требующий перевода. Для выполнения перевода независимо от [настройки](Glossary_o_einstellungen.md) перевода Сегмент в словаре должно содержаться соответствующее ключевое слово со знаком-заполнителем (напр., "Аварийный переключатель ***%0***").
