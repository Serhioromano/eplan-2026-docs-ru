...
В диалоговых окнах можно выполнять и изменять [настройки](Glossary_o_einstellungen.md), сортировать данные, выполнять команды и операции, управлять данными, обрабатывать [свойства](Glossary_o_eigenschaften.md) и многое другое.
...
Навигатор страниц, [навигаторы](Glossary_o_navigatoren.md) для устройств, управление слоями и управление сообщениями являются "присоединяемыми" диалоговыми окнами. Это означает, что эти диалоговые окна, как и строки меню и [панели инструментов](Glossary_o_symbolleisten.md), можно располагать в главном окне EPLAN или за его пределами по своему усмотрению.

Внутри главного окна вы можете [присоединить](Glossary_o_andocken.md) такие диалоговые окна к верхнему, левому, нижнему или правому краю окна, а также к другим присоединяемым элементам.

Кроме того, все навигаторы, предварительный просмотр графики, открытые страницы проекта, [формы](Glossary_o_formulare.md) и т. д. можно присоединить как вкладку. Размещенные друг над другом в качестве вкладок окна образуют оптическую единицу — так называемую ***группу вкладок***.
...
* В ***Навигатор страниц*** [объекты](Glossary_o_objekte.md) могут отображаться в виде древа или списка, при этом под "Списком" имеется в виду ***Таблица***. Поэтому управление списками в Навигаторе страниц отличается от использования "обычных" списков в навигаторах.
...
!!! tip "Совет:"
    ...
    Прежде чем перемещать [разделитель](Glossary_o_trennzeichen.md) окна, следует сначала определить размер диалогового окна, для которого определяется разделитель.
