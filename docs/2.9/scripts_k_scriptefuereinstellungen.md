...
Простые [сценарии](Glossary_o_scripte.md) можно использовать для того, чтобы считывать и изменять настройку из диалогового окна "Настройки".

!!! note "Замечание:"

    Это ***не*** касается ***настроек проекта***!

Перед считыванием [настройки](Glossary_o_einstellungen.md) необходимо узнать ее имя. Для этого включите с помощью следующего сценария C# скрытое всплывающее меню:
