...
* Вы выделили специальный текст или функциональный текст [зоны](Glossary_o_schaltplanpfade.md) и выбрали пункты меню Обработать > Свойства или дважды щелкнули по специальному тексту или функциональному тексту зоны.
...
На этой вкладке обрабатываются [свойства](Glossary_o_eigenschaften.md) просмотра текста. Таким текстом может быть, например, свободно размещенный на странице проекта текст, а также функциональный текст зоны, текст [обозначения](Glossary_o_bezeichnungen.md) гиперссылки, указание размеров или специальный текст и т. д.

Обзор основных элементов диалогового окна:

### Свойство/присвоение:

Здесь доступны [уровни](Glossary_o_etagen.md) иерархии Формат, Рамка текста, Блок выравнивания, Значение / единица измерения, Позиция и Дата / время, открыть которые можно, щелкнув по символу ![](images/all_plussign_as.png){: .ui-icon }.

!!! note "Замечание:"

* Для ***указаний размеров***, ***гиперссылок*** и ***графических файлов*** доступен только уровень иерархии Формат. Для ***графических файлов*** изменению подлежат только [настройки](Glossary_o_einstellungen.md) Слой и Невидимый.
...
Если установлен этот флажок, размер [рамки](Glossary_o_normblaetter.md) текста принимает настройки, указанные в Параметры > Настройки > Проект > "Имя проекта" > Графическая обработка > Общ..
...
!!! note "Замечание:"
    ...
    При использовании [опции](Glossary_o_projektoptionen.md) Выравнивание (вставка Формат) одновременно выравнивается и блок выравнивания. При использовании опции Угол (также через свойство Формат) одновременно поворачивается и блок выравнивания. Если блок выравнивания содержит заполнитель для графического символа, он поворачивается на указанный угол, при этом можно использовать любой угол.
...
* В раскрывающемся списке Формат даты, например, для [свойства проекта](Glossary_o_projekteigenschaften.md) День недели можно выбрать индивидуальный формат даты, к примеру "ГГГГ" для отображения года "2018".
