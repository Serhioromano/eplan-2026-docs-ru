...
В управлении контуром можно [создать](Glossary_o_erstellen.md) дополнительные [отверстия](Glossary_o_bohrungen.md). В этих местах будет применяться выбранное сверло. Отверстие можно разместить свободно или на точках захвата контура.
...
Чтобы сделать видимыми в открытом контуре сохраненные записи данных ЧУ, используйте [функции](Glossary_o_funktionen.md) Вид > Следующая запись данных ЧУ и Вид > Предыдущая запись данных ЧУ.
