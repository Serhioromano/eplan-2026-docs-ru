...
Ключевые слова, тексты перевода или подлежащие переводу [проекты](Glossary_o_projekte.md) и тексты изделий могут содержать цифры, например текст "Terminal with ***3*** connectors". В зависимости от принципа работы при импортировании, экспортировании или переводе текстов, эти цифры сохраняются или заменяются заполнителем.
