...
Вы можете отправить по электронной почте за один раз только один проект. При пересылке проекта [свойства проекта](Glossary_o_projekteigenschaften.md) не изменяются, в частности, сохраняется защита от записи. Вместе с проектом пересылается и информация, что проект выгружен.
...
* Вы установили посредством Параметры > Настройки > Пользователь > Резервирование данных > Настройки > Предварительные настройки  предварительные [настройки](Glossary_o_einstellungen.md) для Носитель для резервирования "Электронная почта".
...
4. Выполните аналогичные [действия](Glossary_o_aktionen.md) для всех других выбранных проектов.

Условие:

Если проект разделен на несколько электронных проектов, файлы нужно [сохранить](Glossary_o_einlagern.md) в общем каталоге.
