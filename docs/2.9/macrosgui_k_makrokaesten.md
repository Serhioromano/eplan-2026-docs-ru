...
Путем вставки рамок макросов в ***проекте макросов*** указывается, какое содержимое следует [сохранить](Glossary_o_einlagern.md) в макросах (данные, [контуры](Glossary_o_konturen.md) макросов). Из этих подготовленных макросов можно впоследствии автоматически сгенерировать [макросы окон](Glossary_o_fenstermakros.md) и / или символов.

Вставить [рамки макросов](Glossary_o_makrokaesten.md) в ***проект схемы соединений*** невозможно. Однако при создании макросов окон или символов в таком проекте рамка макросов также сохраняется в макросе в соответствии с указанным фрагментом.

Специальные пункты всплывающего меню в рамке макросов позволяют впоследствии обновлять состояния вставленных макросов. Кроме того, с помощью [функции](Glossary_o_funktionen.md) присвоения объекта вручную можно присваивать макросу [объекты](Glossary_o_objekte.md), находящиеся за пределами [рамки](Glossary_o_normblaetter.md) макросов. Это можно сделать как в проекте макросов, так и в проекте [схемы соединений](Glossary_o_anschlussbilder.md), если вставлены рамки макросов.

!!! note "Замечание:"

    В макросе страницы рамка макроса отсутствует. Данные макроса (имя, описание, версия и т. д.) сохранены в свойствах страниц, содержащихся в макросе, на вкладке Страница и / или Определение макроса. В проекте [схемы](Glossary_o_schemata.md) соединений вкладка Определение макроса не отображается. Данные можно просмотреть в свойствах страницы в категории "Макрос".
...
Если при подготовке макроса для [настройки](Glossary_o_einstellungen.md) Вставить также рамку макроса выбран параметр "Из настроек проекта", для всего проекта схемы соединений можно указать, что рамки макросов также вставляются. Для этого активируйте настройку проекта [Вставить также рамки макросов](gedviewer_d_einstellungenprojektallgemein.md).
...
Кроме того, [метод использования](macrosgui_r_makrokasten.md) позволяет лучше различать подготовленные [макросы](Glossary_o_makros.md) в навигаторе макросов.
...
Правильность применения метода использования рамок макросов в проектах можно проверить с помощью [сообщения контрольного прогона](Glossary_o_prueflaufmeldungen.md) 014006 из класса сообщений 014 "Макросы".
