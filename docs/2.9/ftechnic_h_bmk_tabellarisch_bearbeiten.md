...
В следующем примере показано, как простым способом можно изменить созданные согласно DIN ISO 1219-2 [обозначения](Glossary_o_bezeichnungen.md) [устройства](Glossary_o_betriebsmittel.md) Fluid с помощью табличной обработки. При этом компонентам идентификатора "Номер установки" и "Номер логической ячейки" вставленных устройств за рабочий шаг должны быть присвоены новые значения.
...
* На этой странице вы, к примеру, разместили четыре 2/2-ходовых клапана V11.5.1_22_02 из [библиотеки символов](Glossary_o_symbolbibliotheken.md) PNE1ESS.
...
1. Откройте страницу [схемы соединений](Glossary_o_anschlussbilder.md) Fluid-техники в образце проекта.
...
В диалоговом окне Табличная обработка — <Имя проекта> [свойства](Glossary_o_eigenschaften.md) выбранного устройства отображаются в форме таблицы. Отображение столбцов таблицы зависит от выбранной [схемы](Glossary_o_schemata.md).

После установки EPLAN Fluid доступны уже готовые схемы. По умолчанию задана схема "Все [функции](Glossary_o_funktionen.md)", покрывающая широкий спектр важных функциональных данных. Схема "Устройства Fluid" предназначена специально для обработки устройств Fluid в табличной форме.
...
7. Переместите эту строку в начало с помощью кнопок со стрелками на [панели инструментов](Glossary_o_symbolleisten.md).
...
5. Выполните такие же [действия](Glossary_o_aktionen.md) со столбцом Номер логической ячейки, который во всех ячейках должен принять значение "3".
6. Щелкните по схеме соединений, чтобы отобразить и [сохранить](Glossary_o_einlagern.md) это изменение.
