...
Параметры > Настройки. Выделите область [настройки](Glossary_o_einstellungen.md) "Проект" или "Фирма" и щелкните по кнопке ![](images/all_import_as.png){: .ui-icon } (Импортировать).
