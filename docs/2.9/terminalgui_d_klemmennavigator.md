...
В этом диалоговом окне выводятся все клеммники и клеммы открытого проекта. Каждая клемма отображается со своим определением [функции](Glossary_o_funktionen.md), структурным идентификатором установленной структуры [устройства](Glossary_o_betriebsmittel.md) и обозначением позиции. Здесь можно выбрать отдельные или несколько клемм или клеммников. С помощью всплывающего меню можно создавать новые клеммники и клеммы или вызывать соответствующие диалоговые окна для обработки.

Обзор основных элементов диалогового окна:

В ***Представл. структ. дерева*** отображаются клеммы, отсортированные по клеммникам. Под ОУ клеммников отображаются соответствующие [определения клеммников](Glossary_o_klemmenleistendefinitionen.md) и клеммы.

В ***представлении в виде списка*** стандартно выводятся на просмотр определение функции и идентифицирующее имя. Дополнительно могут быть отображены и другие [свойства](Glossary_o_eigenschaften.md) (например, обозначение клемм / штекерных контактов, возможность установки мостовых перемычек и т. д.).
...
Новые клеммы (устройства) |  Открывает диалоговое окно Генерировать клеммы (устройства), позволяющее для новых или уже имеющихся ОУ сгенерировать несколько клемм по определенному образцу нумерации. Каждое клеммное устройство имеет по одной главной клемме: этой главной клеммой становится первая сгенерированная клемма, которой присваивается выбранное [изделие](Glossary_o_artikel.md).
