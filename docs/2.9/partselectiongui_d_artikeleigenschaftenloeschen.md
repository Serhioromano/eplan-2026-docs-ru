...
В этих диалоговых окнах можно удалить [свойства](Glossary_o_eigenschaften.md) сохраненных в проекте изделий. Возможен вызов для всего проекта, выделенных страниц или выделенных элементов в графическом редакторе.

Обзор основных элементов диалогового окна:

### Настройки:

В данном раскрывающемся списке отображаются все пользовательские и предварительно определенные [схемы](Glossary_o_schemata.md). Выберите схему, чтобы задать [настройки](Glossary_o_einstellungen.md) для удаления сохраненных свойств. С помощью кнопки ++...++ откройте следующее одноименное диалоговое окно, в котором можно обработать схемы и управлять ими.
