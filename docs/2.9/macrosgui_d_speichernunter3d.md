...
Вы открыли проект, а в нем открыли [пространство листа](Glossary_o_bauraum.md). Вы выделили требуемые [объекты](Glossary_o_objekte.md) 3D, которые необходимо [сохранить](Glossary_o_einlagern.md) в виде макроса. Обработать > Создать макрос окна / символа.

В этом диалоговом окне выделенные объекты 3D сохраняются как [макросы](Glossary_o_makros.md).
...
!!! note "Замечание:"
    ...
    Варианты угла и другие [варианты](Glossary_o_varianten.md) макроса не генерируются автоматически, а должны быть созданы вручную в дереве, а затем сохранены с тем же именем макроса, но с другим обозначением варианта. Можно [создать](Glossary_o_erstellen.md) до 26 вариантов каждого макроса. Если для макроса созданы различные варианты, при вставке можно выбрать один их них.
