...
Нумерация соединений позволяет автоматически присваивать соединениям [обозначения](Glossary_o_bezeichnungen.md). Обозначения соединений также можно присваивать вручную.
...
* В проекте могут использоваться как вручную присвоенные, так и автоматически присвоенные [обозначения соединений](Glossary_o_verbindungsbezeichnungen.md).
* Вы можете исключать из нумерации отдельные [соединения](Glossary_o_verbindungen.md) и присваивать им необходимые обозначения позже.
* Обозначение соединения имеет свободный формат. Обозначение не ограничивается цифрами, оно может содержать буквы и определенные специальные [символы](Glossary_o_symbole.md).
