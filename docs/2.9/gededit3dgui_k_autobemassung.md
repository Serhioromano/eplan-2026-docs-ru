...
Для представленных в обзорах и развертках шины устройств электрошкафа и важных для ЧУ монтажных отверстий (отверстий, фрагментов и т. д.) можно автоматически проставить размеры. Функциональные элементы, для которых необходимо указать размеры, и [свойства](Glossary_o_eigenschaften.md) проставления размеров можно сохранять в схеме как специфические для проекта [настройки](Glossary_o_einstellungen.md). Автоматическое проставление размеров вставляется путем выбора соответствующей [схемы](Glossary_o_schemata.md) в диалоговом окне "Свойства". Для этого используйте на вкладке Вид в таблице Свойства свойство Обзор модели: Схема для автоматического проставления размеров.
