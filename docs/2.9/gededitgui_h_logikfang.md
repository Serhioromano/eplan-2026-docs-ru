...
Логический захват помогает точнее выбрать [символы](Glossary_o_symbole.md) или [макросы](Glossary_o_makros.md) и быстрее разместить их на выбранные [соединения](Glossary_o_verbindungen.md).
...
!!! info "Для сведения:"
    ...
    В этом случае логический захват действует на точки вывода [устройства](Glossary_o_betriebsmittel.md) символов. Выводы устройств символа перемещаются преимущественно на имеющуюся или возможную линию соединения. Это помечается в графическом редакторе небольшим двойным кружком.
