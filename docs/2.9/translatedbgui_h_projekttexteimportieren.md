...
6. Щелкните в поле Перевод рядом с полем Языки по ![](images/all_new_as.png){: .ui-icon } (Создать), выберите один за другим те [языки перевода](Glossary_o_uebersetzungssprachen.md), тексты проекта на которых нужно импортировать в словарь.
