...
В этом диалоговом окне в представлении в виде дерева или списка выборочно можно просмотреть и изменить предварительно определенные в проекте [кабели](Glossary_o_kabel.md).

Обзор основных элементов диалогового окна:

В ***Представлении структуры дерева*** [кабельные соединения](Glossary_o_kabelverbindungen.md) отображаются отсортированными по кабелям. Внизу ОУ кабеля отображаются соответствующие линии определения кабелей, [экранирования](Glossary_o_abschirmungen.md) и кабельные [соединения](Glossary_o_verbindungen.md).

В ***представлении в виде списка*** по умолчанию отображаются идентифицирующее имя, определение [функции](Glossary_o_funktionen.md) и ОУ источника и цели. Дополнительно можно просмотреть все [свойства](Glossary_o_eigenschaften.md), которые доступны для соединений, а также другие специфические для кабелей свойства (например, Кабель / Группа соединений: Число соединений, Кабель / Группа соединений: Поперечное сечение / диаметр и т. д.).
...
Отобразить маршрутизируемое соединение |  Отображает выбранные [маршрутизируемые соединения](Glossary_o_verlegeverbindungen.md) или все имеющиеся маршрутизируемые соединения в сети соединенных сегментов.
