...
Если вы генерируете отчет из [шаблона отчетов](formgeneratorgui_k_auswertungsvorlagen.md), то вам не нужно больше устанавливать все [настройки](Glossary_o_einstellungen.md). Все настройки, которые уже были установлены в шаблоне, применяются для отчета.
