...
С помощью некоторых операций, которые Вы можете установить в виде кнопок на панелях инструментов, можно устанавливать [настройки](Glossary_o_einstellungen.md) форматирования условных обозначений, текстов, графических элементов и точек определения соединений и потенциалов на точно заданные значения. При этом возможности настройки идентичны тем, которые вы можете определить в соответствующих диалоговых окнах свойств во вкладках Отображение, Формат и Графика соединения.

Для форматирования свойств доступны следующие операции:

* Установить формат условного [обозначения](Glossary_o_bezeichnungen.md) (имя операции: XGedIaFormatSymbol)
...
* Установить формат графики соединений (точки определения [соединения](Glossary_o_verbindungen.md), [точки определения потенциала](Glossary_o_potenzialdefinitionspunkte.md)) (имя операции: XGedIaFormatDefPoints).

В следующих таблицах приведены ***все возможные параметры*** этих операций. Точный синтаксис для отдельной операции можно увидеть в образце записи в командной строке. Эта запись видна в диалоговом окне Конфигурировать кнопку, когда вы добавляете кнопку [действия](Glossary_o_aktionen.md) на панель инструментов. Если свойство не изменится, то просто оставьте соответствующий вопросительный знак "?" в командной строке.
...
/radius:? |  Радиус дуги (применяется только для закругленных прямоугольников; радиус [закругления](Glossary_o_abrundungen.md) углов) |  Числовые значения в "мм" или в "In" (дюйм)
...
* AllLanguagesColumn = Все [языки отображения](Glossary_o_anzeigesprachen.md) (рядом друг с другом)
...
/propertyId:? |  Идентификатор определяемого [свойства](Glossary_o_eigenschaften.md) условного обозначения (= номер свойства)
