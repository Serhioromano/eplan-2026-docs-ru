...
Если выделить макрос в навигаторе макросов, в окне предварительного просмотра графики отобразится соответствующая страница / [пространство листа](Glossary_o_bauraum.md) проекта макросов.

Возможно следующее:

* С помощью всплывающего меню можно просматривать и обрабатывать [свойства](Glossary_o_eigenschaften.md) макросов. При этом открывается соответствующее диалоговое окно 'Свойства' (например, для макроса окна открывается диалоговое окно 'Свойства' [рамки](Glossary_o_normblaetter.md) макроса).
* С помощью пункта всплывающего меню Перейти к (графика) можно перейти в графический редактор или пространство листа и, например, обрабатывать там нужный фрагмент [схемы соединений](Glossary_o_anschlussbilder.md) или соответствующие трехмерные [объекты](Glossary_o_objekte.md).
* При помощи фильтра отображение можно ограничить до макросов, которые соответствуют определенным критериям. Это позволяет отображать, например, только макросы определенного вида представления, а затем [генерировать](Glossary_o_erzeugen.md) их автоматически.
...
В дереве навигатора макросов имеющиеся в макросе [объекты-заполнители](Glossary_o_platzhalterobjekte.md) представлены под уровнем иерархии соответствующего варианта макроса (пиктограмма ![](images/cabinetgui_placeholder_as.png){: .ui-icon }). Доступен многократный выбор объектов-заполнителей, но [групповая обработка](Glossary_o_blockbearbeitung.md) возможна только при выполнении определенных [условий](macrosgui_h_platzhalterobjekteerzeugen.md). С помощью всплывающего меню для объектов-заполнителей можно выбрать наборы значений и обработать их свойства.

### Вставить макросы из навигатора макросов путем перетаскивания мышью

Макросы окон и символов одного проекта макросов можно вставлять из навигатора макросов в открытые страницы другого проекта макросов или [схемы](Glossary_o_schemata.md) соединений либо того же проекта макросов путем перетаскивания мышью.
