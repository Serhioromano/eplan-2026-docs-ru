...
Свойства блока не являются многоязычными, результат отображается в виде простой символьной строки. Язык, на котором отдельные активированные свойства записываются в результат, можно установить отдельно для каждого свойства. Если выбираются "Все [языки отображения](Glossary_o_anzeigesprachen.md)" для одного свойства, то все настроенные языки отображения записываются друг за другом с новой строки в результат.
...
С объектом взаимосвязаны следующие другие [объекты](Glossary_o_objekte.md):

* Проект, в котором расположен объект
* Страница, на которой размещен объект
* Объекты, связанные с этим объектом соединениями
* Соединения и [кабели](Glossary_o_kabel.md), подключенные к объекту
* Данные главной [функции](Glossary_o_funktionen.md)
...
Как и в случае со свойствами формата, в открывшемся диалоговом окне Формат устанавливается, какие свойства и разделители будут объединены в свойстве блока. Для функций в этом диалоговом окне доступен элемент формата "Функциональный текст [зоны](Glossary_o_schaltplanpfade.md)". С помощью кнопки ![](images/all_stairup_as.png){: .ui-icon } (Следующая степень) вы можете перейти на соответствующий функциональный текст зоны и выбрать его в качестве элемента формата для автоматического функционального текста.
