...
Здесь можно обработать все данные ПЛК или отдельных карт ПЛК. Каждая карта перечисляется вместе со своими данными, точками подвода питания, адресами (каналами) и принадлежащими адресам выводов [устройства](Glossary_o_betriebsmittel.md). Кроме того, можно [генерировать](Glossary_o_erzeugen.md) [блоки](Glossary_o_bloecke.md) и [выводы устройства](Glossary_o_anschluesse.md) ПЛК.

Обзор основных элементов диалогового окна:

На вкладке Дерево выводятся данные ПЛК с сортировкой по структуре проекта. При этом у вас есть возможность выбирать различные виды для отображения данных ПЛК. В зависимости от выбранного вида [объекты](Glossary_o_objekte.md) ПЛК бывают представлены следующими стоящими перед ними пиктограммами:
...
![](images/navplc_moduleonrack_as.png){: .ui-icon } |  Карта ПЛК вставлена в [каркас](Glossary_o_baugruppentraeger.md) |  ориентировать по каркасу
...
!!! tip "Совет:"
    ...
    В представлении структуры дерева также отображаются изделия, присвоенные карте ПЛК. Если выделено такое [изделие](Glossary_o_artikel.md), то вместе с ним на странице проекта можно разместить привязанный макрос, перетащив его с помощью мыши. Различные виды отображения данных ПЛК в навигаторе ПЛК позволяют быстро найти требуемые [функциональные элементы](Glossary_o_bauteile.md) с присвоенными изделиями.

На вкладке Список по умолчанию выводятся автоматический функциональный текст, адрес, а также символический адрес. Дополнительно можно отобразить все другие [свойства](Glossary_o_eigenschaften.md) ПЛК.
...
Пункт меню |  Значение
---|---
Создать |  Открывает диалоговое окно Определения функций и предлагает возможность вставки вывода устройства или блока ПЛК с заданными свойствами. В зависимости от выделенного ранее объекта в диалоговом окне Определения функций в соответствующем месте раскрывается дерево для выбора определения [функции](Glossary_o_funktionen.md). Если, например, на функции вызвано всплывающее меню, в дереве выделяется соответствующее определение функции.
...
* С ориентацией на канал: Данные ПЛК располагаются в пределах структуры проекта по каналам. Выводы устройства ПЛК, не имеющие [обозначения](Glossary_o_bezeichnungen.md) канала, упорядочиваются по ОУ.
