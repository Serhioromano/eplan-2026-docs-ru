...
Чтобы изменять [профиль](Glossary_o_verlauf.md) трубопровода в соответствии с установочным положением, можно изменять, дополнительно вставлять и удалять содержащиеся в нем колена труб.

Условия:

* Вы открыли проект. Открыто одно [пространство листа](Glossary_o_bauraum.md).
* Пространство листа содержит свободно маршрутизируемые [трубопроводы](Glossary_o_leitungen.md).
...
!!! info "Для сведения:"
    ...
    Колено трубы перемещается в выбранное положение, а прилегающие [сегменты](Glossary_o_segmente.md) и угол колен труб изменяются соответственно.
