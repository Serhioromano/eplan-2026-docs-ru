...
Чтобы было удобнее управлять определенными пользователем и существующими в проекте порядками свойств и обрабатывать их для 3D-[размещения изделий](Glossary_o_artikelplatzierungen.md) и условных обозначений, теперь на платформе EPLAN доступно новое диалоговое окно [конфигурации](Glossary_o_konfigurationen.md).
...
[![](images/eservicesgui_configpropertyarrangement_ls_thumb_0_60.png)](../Pictures/Gui/Lang/eservicesgui_configpropertyarrangement_ls.png)
...
Для поиска используемых определенных пользователем порядков свойств во всплывающем меню представления в виде дерева и в виде списка доступен пункт меню Вставить в список результатов поиска. Этот пункт меню проверяет использование выделенных порядков свойств в проекте и вносит найденные [объекты](Glossary_o_objekte.md) в [список результатов](Glossary_o_ergebnislisten.md) поиска. Благодаря этому с помощью пункта всплывающего меню Перейти к (графика) можно найти используемые порядки свойств объектов, например [условные обозначения](Glossary_o_schaltzeichen.md), размещения изделий и т. д., в графике.
...
Чтобы отобразить [образ контакта](Glossary_o_kontaktspiegel.md) для определенной [функции](Glossary_o_funktionen.md), на этой вкладке щелкните по кнопке ![](images/all_new_as.png){: .ui-icon } (Создать) и в последующем диалоговом окне задайте выравнивание образа контакта ("В зоне", "На условном обозначении"). После выбора выравнивания образа контакта в правой части таблицы Свойство / присвоение можно обработать уже известные настройки образа контакта.

[![](images/devicetaggui_contactimage_ls_thumb_0_60.png)](../Pictures/Gui/Lang/devicetaggui_contactimage_ls.png)
