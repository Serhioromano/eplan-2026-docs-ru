...
***Устройства*** являются логическими электротехническими или (гидравлическими / пневматическими) взаимодействующими единицами Fluid-Техники. Им присваивается обозначение [устройства](Glossary_o_betriebsmittel.md) (ОУ), например M1, K1, X1, XS1, W1. Устройство состоит из одной или нескольких функций (двигатель, катушка, замыкающий контакт, размыкающий контакт и т. д.). Все [функции](Glossary_o_funktionen.md) с одинаковым ОУ относятся к одному и тому же устройству. Одна из функций является так называемой главной функцией. На ней можно выбирать / вводить изделия (исключения: клеммы (изделия можно сохранять только на главных клеммах), контакты штекера, [выводы устройства](Glossary_o_anschluesse.md) сборной шины и [соединения](Glossary_o_verbindungen.md)).

Если изделиям присвоены [шаблоны функций](Glossary_o_funktionsschablonen.md), они будут отображаться в навигаторе устройств на устройстве.
