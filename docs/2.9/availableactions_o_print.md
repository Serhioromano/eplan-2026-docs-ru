...
* Если страница в параметре PAGENAME не указана, то определяются страницы проекта. Если параметр USEPAGEFILTER установлен на 1 (то есть активирован [фильтр](Glossary_o_filter.md) страниц), то в навигаторе страниц распечатываются только отфильтрованные страницы. Если параметр USEPAGEFILTER не используется или установлен на 0, выводятся на печать все страницы проекта.
