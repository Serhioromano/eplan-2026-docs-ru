...
RouteConnections: Маршрутизирует выбранные [соединения](Glossary_o_verbindungen.md) топологии.
CreateFunctions: Автоматически генерирует [функции](Glossary_o_funktionen.md) топологии.
