...
USESELECTION  |  Устанавливает, необходимо ли учитывать текущий выбор в интерфейсе пользователя при выводе данных [провода](Glossary_o_draehte.md) (необязательно, 0 = Нет, 1 = Да).
