...
В этом диалоговом окне перечисляются все [штекеры](Glossary_o_stecker.md) и штекерные контакты, используемые в открытом проекте. Каждый контакт штекера отображается вместе со своим определением [функции](Glossary_o_funktionen.md), идентифицирующим ОУ и обозначением положения. Здесь контакты штекера или штекеры можно выбрать по отдельности или сразу несколько. С помощью всплывающего меню вы можете [создать](Glossary_o_erstellen.md) новые штекеры или контакты, или же вызвать соответствующий диалог для редактирования.
...
В ***представлении в виде списка*** стандартно выводятся на просмотр определение функции и идентифицирующее имя. Кроме того, отображаются дополнительные [свойства](Glossary_o_eigenschaften.md) (например, Обозначение клеммы / контакта штекера, Присвоение штекеру (Сторона со штырями / гнездами) и т. д.).
...
Нумерация контактов штекеров |  Открывает диалоговое окно Нумерация контактов штекеров. В этом окне вы можете задать специальные виды форматирования для [обозначения](Glossary_o_bezeichnungen.md) штекерных контактов.
