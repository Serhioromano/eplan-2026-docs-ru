...
Вы выбрали базу данных управления проектами. Вы считали каталоги и [проекты](Glossary_o_projekte.md). Проект > Управление. Выделите проект. Выберите ++Дополнительно++ > Показать пользователей.
