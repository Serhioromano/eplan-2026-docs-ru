...
* "Одиночные" сценарии, [функции](Glossary_o_funktionen.md) которых ***выполняются однократно***, можно запустить с помощью пункта меню Выполнить.
...
* Посредством сценариев можно добавить новые операции EPLAN. При этом новая операция может интегрироваться в EPLAN в качестве пункта меню или кнопки [панели инструментов](Glossary_o_symbolleisten.md).
