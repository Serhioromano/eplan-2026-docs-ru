...
С помощью этой [функции](Glossary_o_funktionen.md) можно выровнять оба конца кривой по касательной к краю. В зависимости от выбранного края это действие может дать разные результаты:
...
* Конец кривой должен входить в вывод [устройства](Glossary_o_betriebsmittel.md) вертикально, чтобы избежать изгибания соединений с большими поперечными сечениями.
