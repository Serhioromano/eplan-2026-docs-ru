...
Кроме того, для направления создания отчета релевантны [свойства](Glossary_o_eigenschaften.md) Ширина столбца и Высота строки. Путем ввода положительных или отрицательных значений указывается, выполняется отчет слева направо, сверху вниз или в обратном направлении.
...
---|---|---
Выравнивание [формы](Glossary_o_formulare.md) |  По строкам
Ширина столбца |  +
Высота строки |  +
