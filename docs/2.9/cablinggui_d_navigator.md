...
В представлениях в виде ***дерева*** и ***списка*** отображаются элементы сетей соединенных элементов: [сегменты маршрутизации](Glossary_o_strecken.md), [точки маршрутизации](Glossary_o_verlegepunkte.md) и цели — с полной структурой идентификаторов. В качестве цели отображаются только [функции](Glossary_o_funktionen.md) топологии, но не цельные [устройства](Glossary_o_betriebsmittel.md).

В ***представлении в виде списка*** можно отображать дополнительные [свойства](Glossary_o_eigenschaften.md), доступные для сетей соединенных сегментов и устройств.

В представлении структуры дерева навигатора топологии отображаются в том числе следующие [пиктограммы](Glossary_o_icons.md):
...
Маршрутизировать |  Дает возможность [маршрутизировать](Glossary_o_verlegen.md) выделенные соединения в [сети соединенных сегментов](Glossary_o_streckennetze.md).
