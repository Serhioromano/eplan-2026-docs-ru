...
В этом диалоговом окне можно управлять схемами экспорта данных изготовления / маркировки и обрабатывать их. На этой схеме заданы соответствующие [настройки](Glossary_o_einstellungen.md).
...
Схема для экспорта / маркировки всегда создается вместе с типом отчета. В этом поле выводится тип отчета, который был выбран для текущей [схемы](Glossary_o_schemata.md).
