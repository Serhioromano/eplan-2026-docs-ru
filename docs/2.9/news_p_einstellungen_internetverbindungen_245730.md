...
С помощью нового параметра для настроек LAN [настройки](Glossary_o_einstellungen.md) прокси можно копировать из операционной системы, и вам не нужно дополнительно вручную вводить регистрационные данные прокси на платформе EPLAN.
