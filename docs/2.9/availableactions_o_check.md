...
INSTALLATIONSPACE: Проверить [пространство листа](Glossary_o_bauraum.md)
...
VERIFICATIONSCHEME  |  Имя [схемы](Glossary_o_schemata.md), используемой для контрольного прогона (является опцией, только имя схемы, без пути файла).
