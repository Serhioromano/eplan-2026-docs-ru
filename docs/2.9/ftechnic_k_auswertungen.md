...
В EPLAN Fluid можно [генерировать](Glossary_o_erzeugen.md) [отчеты](formgeneratorgui_k_start.md) проекта. Например, можно выводить списки устройств / изделий или даже специфические для соединений [отчеты](Glossary_o_auswertungen.md), например списки трубных или шланговых соединений или [схемы](Glossary_o_schemata.md) групп соединений / проводов. EPLAN Fluid позволяет использовать многочисленные [типы отчетов](formgeneratorgui_k_auswertungstypen.md).
