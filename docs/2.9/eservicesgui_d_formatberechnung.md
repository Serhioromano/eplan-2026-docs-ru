...
В этом диалоговом окне при помощи элементов формата можно [создать](Glossary_o_erstellen.md) формулу вычисления для данных проекта и данных изделий, чтобы вывести ее в отчете.

Обзор основных элементов диалогового окна:

### Доступные элементы формата:

В данном поле отображаются все [элементы формата](Glossary_o_formatelemente.md), которые могут быть составной частью расчетной формулы. Чтобы скопировать элемент формата для расчетной формулы в поле Выбранные элементы формата, выделите его и нажмите на ![](images/all_arrowright_as.png){: .ui-icon } (переместить вправо).
...
В этом групповом поле задается, когда [данные проекта](Glossary_o_projektdaten.md) / изделия не должны выводиться. Выберите оператор из раскрывающегося списка. В расположенном ниже поле введите значение для условия.
...
Если этот флажок установлен, то данные проекта, выполняющие условия расположенных выше полей, включая предшествующий [разделитель](Glossary_o_trennzeichen.md), выводиться не будут. Эта настройка относится к элементу формата Разделитель, предшествующему элементу формата Вычисление.
