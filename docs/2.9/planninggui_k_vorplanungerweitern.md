...
Чтобы дополнить существующее предварительное планирование графическими представлениями и функциональными схемами автоматизации, во всех сегментах предоставляется возможность сохранения макроса окна с графическим предварительным планированием или фрагментами функциональной [схемы](Glossary_o_schemata.md) автоматизации.

Для этого на первой вкладке в диалоговом окне 'Свойства' доступно свойство Макрос для предварительного планирования и функциональная схема автоматизации ([ид.](Glossary_o_id.md) 44084). Если для [свойства](Glossary_o_eigenschaften.md) выбран макрос окна с видом представления "Предварительное планирование" и / или "Функциональная схема автоматизации", с помощью [функции](Glossary_o_funktionen.md) перетаскивания вы можете разместить этот сегмент на странице проекта соответствующего типа страницы вместе с фрагментами, имеющимися в макросе окна.
...
!!! note "Замечание:"
    ...
    Для нижестоящих сегментов, которые существуют только в макросе окна, создаются новые размещенные [сегменты](Glossary_o_segmente.md). Нижестоящие сегменты, которые существуют только в проекте, не размещаются.
...
!!! tip "Совет:"
    ...
    Мы рекомендуем сохранять на вкладке Макрос преимущественно [макросы](Glossary_o_makros.md), которые вы используете для создания детального планирования, а [макросы окон](Glossary_o_fenstermakros.md), которые вы используете для расширения графического предварительного планирования или функциональной схемы автоматизации, вводить в свойстве Макрос для предварительного планирования и функциональная схема автоматизации.
