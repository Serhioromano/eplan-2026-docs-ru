...
В EPLAN [проекты](Glossary_o_projekte.md) можно экспортировать в формат вывода PDF (***P***ortable ***d***ocument ***f***ile), причем данный формат также учитывает логические элементы и ссылки. При помощи этой [функции](Glossary_o_funktionen.md) возможно высококачественное архивирование проектов, так как в файле PDF сохраняется не только чистая графика, но и большая часть логической структуры проекта EPLAN.
