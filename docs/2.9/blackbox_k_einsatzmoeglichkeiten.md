...
* Выводы [устройства](Glossary_o_betriebsmittel.md) в черном ящике:
Одна или несколько функций должны быть реализованы не посредством готового символа, а при помощи черного ящика с выводами устройства; при этом следует также показать логическую информацию (напр., для представления внутренней коммутационной [схемы](Glossary_o_schemata.md)).
