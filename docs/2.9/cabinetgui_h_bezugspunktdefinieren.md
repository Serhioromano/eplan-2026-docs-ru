...
Пользовательские исходные точки — это размещенные пользователем вручную в макросе [точки монтажа](Glossary_o_montagepunkte.md) с заранее определенными свойствами, которые можно использовать в базе данных принадлежностей в качестве [свойства](Glossary_o_eigenschaften.md) размещения принадлежностей. С помощью них можно настроить места для размещения макроса в качестве детали [принадлежности](Glossary_o_zubehoer.md) на перфорированном профиле и корпусе.
...
5. Выберите пункт всплывающего меню Опции размещения, чтобы в диалоговом окне [Опции размещения](cabinetgui_d_platzieroptionen.md) задать произвольный угол вращения для оси X и / или [смещение](Glossary_o_offset.md) в направлении X, Y и Z.
