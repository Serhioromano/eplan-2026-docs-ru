...
* Пространство листа содержит импортированные трехмерные тела, которые необходимо [сохранить](Glossary_o_einlagern.md) в виде электрошкафа или [принадлежности](Glossary_o_zubehoer.md).
...
3. Щелкните по кнопке ++OK++.Инструменты для монтажных работ, например точки захвата, [точки монтажа](Glossary_o_montagepunkte.md), [монтажные поверхности](Glossary_o_montageflaechen.md) и т. д., являются элементами логики устройств.
...
6. Переключайте при необходимости во время размещения при помощи кнопки ++A++ точку захвата или используйте для этого контекстное меню Опции размещения, чтобы указать через одноименное диалоговое окно точку захвата, а также [смещение](Glossary_o_offset.md) для выбранной точки захвата относительно позиции курсора.
...
На монтажной поверхности или профиле была определена [монтажная сетка](Glossary_o_montageraster.md).
