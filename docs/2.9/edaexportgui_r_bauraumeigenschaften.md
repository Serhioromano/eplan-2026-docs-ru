...
На вкладке Свойства пространства листа можно просмотреть [свойства](Glossary_o_eigenschaften.md) пространств листа экспортируемого проекта, но нельзя их изменить.
