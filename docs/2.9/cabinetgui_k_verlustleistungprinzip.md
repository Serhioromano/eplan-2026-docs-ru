...
Все факторы для определения рамочных условий представляют собой [свойства](Glossary_o_eigenschaften.md) изделий или размещений изделий, значения которых пользователь должен правильно задать при проектировании.
...
Расчет мощности потерь [устройства](Glossary_o_betriebsmittel.md) осуществляется по формуле:
...
Условные [обозначения](Glossary_o_bezeichnungen.md) в формуле:
...
* ***длина шины*** в метрах [м] (из свойства [ссылки изделия](Glossary_o_artikelreferenzen.md) Подмножество / длина в единицах измерения проекта).
