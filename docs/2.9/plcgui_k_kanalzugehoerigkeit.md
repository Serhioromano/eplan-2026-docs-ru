...
При определенных графических видах расположения EPLAN распознает автоматически, какие точки подвода питания относятся к выводу В/В [устройства](Glossary_o_betriebsmittel.md). Поиск осуществляется как на страницах [схемы соединений](Glossary_o_anschlussbilder.md), так и на страницах обзора.

### Поиск принадлежности канала на страницах схемы соединений

На страницах [схемы](Glossary_o_schemata.md) соединений поиск начинается на точке подвода питания вверх. Затем поиск продолжается против часовой стрелки на одинаковом удалении ("каждые 15 минут"). Всегда вверху ("до полного часа") интервал повышается.
