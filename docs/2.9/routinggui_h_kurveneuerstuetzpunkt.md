...
Дополнительные опорные точки можно вставлять в любых местах на протяжении кривой. Впоследствии, изменяя новые опорные точки при помощи [функции](Glossary_o_funktionen.md) Изменить направление кривой, можно изменить также форму кривой и ее положение в пространстве.
