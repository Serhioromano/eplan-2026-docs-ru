...
В проектах макросов можно автоматически [генерировать](Glossary_o_erzeugen.md) [макросы](Glossary_o_makros.md).
...
* Открыта страница, на которой вставлены [объекты](Glossary_o_objekte.md) (например, фрагменты [схемы соединений](Glossary_o_anschlussbilder.md), графика и т. д.), из которых автоматически должны быть сгенерированы макросы.

1. Выберите пункты меню Вставить > Блок / Вывод [устройства](Glossary_o_betriebsmittel.md) / Монтажная плата > Рамка макроса.
2. Переместите с помощью мыши рамку таким образом, чтобы разместить в ней требуемые объекты.
3. Повторите этот шаг, пока не будут определены все [рамки макросов](Glossary_o_makrokaesten.md).
4. Завершите операцию, выбрав пункт всплывающего меню Прервать операцию или нажав клавишу ++Esc++.
5. Дважды щелкните по одной из угловых точек [рамки](Glossary_o_normblaetter.md) макроса.
...
!!! info "Для сведения:"
    ...
    Обозначенные рамками макросов области сохраняются как [макросы окон](Glossary_o_fenstermakros.md) и / или символов в указанный при настройке каталог макросов. При этом для необходимых данных используются [свойства](Glossary_o_eigenschaften.md) рамки макроса.
...
* Вы находитесь в проекте макросов.
* как минимум на одной странице вставлены объекты (например, фрагменты [схемы](Glossary_o_schemata.md) соединений, графика и т. д.), из которых автоматически должны быть сгенерированы макросы.
