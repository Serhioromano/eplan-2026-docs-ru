...
Перед генерированием списка отсутствующих слов можно выбрать правила, по которым тексты проекта будут разбиваться на [сегменты](Glossary_o_segmente.md) перевода. Сегмент перевода может соответствовать слову, предложению или общей записи.
...
5. Проверьте, указаны ли необходимые вам [языки перевода](Glossary_o_uebersetzungssprachen.md) в групповом поле Перевод в поле Языки в качестве языков перевода.
...
2. Чтобы экспортировать список отсутствующих слов для отдельных переводимых элементов [схемы](Glossary_o_schemata.md), дважды щелкните на странице и выделите в Графическом редакторе необходимые элементы схемы.
