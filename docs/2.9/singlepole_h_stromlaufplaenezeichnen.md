...
Ниже даются пояснения по созданию простой однополюсной [схемы соединений](Glossary_o_anschlussbilder.md). Сначала к проекту следует добавить однополюсную страницу [схемы](Glossary_o_schemata.md) соединений. После этого на ней размещаются два символа (автомат защиты двигателя и трехфазный двигатель), связанные друг с другом с помощью автоматического [соединения](Glossary_o_verbindungen.md). Появившееся соединение обозначается посредством точки определения соединения.
...
2. В диалоговом окне Выбор символа из раскрывающегося списка Фильтр выберите запись "Однополюс. [символы](Glossary_o_symbole.md) IEC".
...
5. В списке выбора символов нажмите на заголовок столбца Имя, чтобы [имена символов](Glossary_o_symbolnamen.md) отображались по нарастающей.
...
8. Разместите символ на однополюсной странице схемы соединений в графическом редакторе и оставьте в диалоговом окне Свойства ++...++ предварительно заданное обозначение [устройства](Glossary_o_betriebsmittel.md) -Q1, а также обозначение вывода устройства.
...
10. Разместите на схеме соединений трехфазный двигатель с выводом PE / PEN в виде варианта А под автоматом защиты двигателя -Q1 таким образом, чтобы оба условных [обозначения](Glossary_o_bezeichnungen.md) были связаны линией автоматического соединения.
