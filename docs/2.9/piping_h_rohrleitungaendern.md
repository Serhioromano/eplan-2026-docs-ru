...
!!! info "Для сведения:"
    ...
    Сегмент трубы / место изгиба перемещается в требуемое положение, прилегающие [сегменты](Glossary_o_segmente.md) изменяются соответственно.
