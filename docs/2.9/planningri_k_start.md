...
Функциональные [схемы](Glossary_o_schemata.md) автоматизации являются частью документации установки. По умолчанию функциональные схемы автоматизации используются для следующих целей:
...
* Функциональное предназначение аппаратов и механизмов, включая приводные двигатели, транспортирующие [устройства](Glossary_o_betriebsmittel.md) и установленные [резервы](Glossary_o_reserven.md)
...
* Измерительные, регулировочные и управляющие [функции](Glossary_o_funktionen.md) с идентификационным номером
* Основные данные приводных двигателей.

Кроме того, [функциональная схема автоматизации](Glossary_o_ri_fliessbild.md) может содержать следующую дополнительную информацию:
