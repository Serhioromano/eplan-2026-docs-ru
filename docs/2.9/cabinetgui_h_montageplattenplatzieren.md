...
2. В диалоговом окне Выбор изделия выделите требуемое [изделие](Glossary_o_artikel.md) монтажной платы.
...
3. Щелкните по кнопке ++OK++.
4. Разместите произвольную монтажную плату таким же образом, как и [монтажные платы](Glossary_o_montageplatten.md) из [базы данных изделий](Glossary_o_artikeldatenbanken.md).
