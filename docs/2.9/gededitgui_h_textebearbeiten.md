...
2. В диалоговом окне Свойства (текст) обрабатываются текст и его [свойства](Glossary_o_eigenschaften.md). Используйте вкладки [Текст](gededitgui_r_text.md) и [Формат](gededitgui_r_format.md), как описано в разделе "Вставить тексты".
