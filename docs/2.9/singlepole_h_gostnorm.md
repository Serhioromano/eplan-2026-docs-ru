...
EPLAN позволяет получить более наглядное представление кабелей с помощью выводов жгутов. Перед источником кабеля его [кабельные соединения](Glossary_o_kabelverbindungen.md) переходят в кабельный жгут в виде символов выводов жгута.

Рядом с целью кабеля жгут снова расходится в виде символов выводов жгута, а отдельные кабельные [соединения](Glossary_o_verbindungen.md) кабеля проводятся дальше в развернутой (многополюсной) форме. Ниже на конкретном примере показаны все этапы создания такого кабельного представления со жгутами. При этом через кабельный жгут к двигателю должен быть подключен клеммник.

Условия:

* Вы открыли проект.
* Проект содержит новую многополюсную страницу [схемы соединений](Glossary_o_anschlussbilder.md).
...
6. Отпустите клавишу ++Ctrl++ и переместите угол в направлении клеммы 1 таким образом, чтобы произошло [автоматическое соединение](Glossary_o_autoconnecting.md) клеммы с углом.
...
9. При необходимости выберите вкладку Отображение, чтобы задать [настройки](Glossary_o_einstellungen.md) отображения для вывода жгута.
...
16. Таким же образом вставьте еще один тройник и укажите в качестве [обозначения](Glossary_o_bezeichnungen.md) цифру "3".
...
2. Введите в качестве обозначения [устройства](Glossary_o_betriebsmittel.md) "-M1".
...
4. Затем вставьте линию [определения кабеля](Glossary_o_kabeldefinitionen.md) и протяните ее над всеми линиями автоматического соединения между выводами жгутов и клеммником.
5. Введите ОУ кабеля "-W1" и при необходимости присвойте кабелю другие [свойства](Glossary_o_eigenschaften.md).
