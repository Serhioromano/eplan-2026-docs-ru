...
* Вы выделили [соединения](Glossary_o_verbindungen.md) в графическом редакторе или в диалоговом окне навигатора Соединения — <Имя проекта>. Или вы выделили одну или несколько страниц либо проект в диалоговом окне навигатора Страницы — <Имя проекта>. Данные проекта > Соединения > Нумерация > Разместить > [...]. В диалоговом окне Настройки: Нумерация соединений выберите вкладку Отображение.
...
Для этого существуют [уровни](Glossary_o_etagen.md) иерархии Интервал и Формат, которые открываются после щелчка по символу ![](images/all_plussign_as.png){: .ui-icon }.
...
Здесь задается отступ [обозначения](Glossary_o_bezeichnungen.md) соединения от вертикальных частей соединения. Обозначение соединения на вертикальных частях указывается вдоль линии соединения. С помощью этой [настройки](Glossary_o_einstellungen.md) вы можете перемещать обозначение вперед или назад по горизонтали.
