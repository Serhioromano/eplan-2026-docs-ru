...
!!! note "Замечание:"
    ...
    При обмене данными ПЛК в ***формате AutomationML*** выводы шины внутри одной и той же системы шин и одной и той же физической сети (свойство Физическая сеть: Имя) считаются связанными, даже если они имеют разные ОУ. Однако это не видно при отслеживании сети. Контрольный прогон [004104](messages_p_004104.md) сообщает о таких соединениях шин как несвязанных между собой. Это сообщение можно проигнорировать, если вы намеренно спроектировали структуру сети таким образом из-за физических условий.
