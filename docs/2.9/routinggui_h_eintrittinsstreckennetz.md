...
Трассу маршрутизации для [соединения](Glossary_o_verbindungen.md) можно определить, задав точку, в которой маршрутизируемое соединение должно входить в [сеть](Glossary_o_netze.md) соединенных сегментов. Заданное значение можно применять как для маршрутизированных, так и для немаршрутизированных соединений.
...
Сгенерированы соединения или [маршрутизируемые соединения](Glossary_o_verlegeverbindungen.md). Включено отображение маршрута. Отображаются маршрутизируемые соединения. Маршрутизируемое соединение, обозначенное на рисунке красным, должно входить не в средний, а в левый кабельный канал [сети соединенных сегментов](Glossary_o_streckennetze.md).
...
2. Укажите две угловые точки прямоугольника, который охватывает нужные [объекты](Glossary_o_objekte.md).
...
4. Установите флажок в столбце Выбор у тех соединений, которые вы хотите заново [маршрутизировать](Glossary_o_verlegen.md) в выбранном сегменте маршрутизации цели.
