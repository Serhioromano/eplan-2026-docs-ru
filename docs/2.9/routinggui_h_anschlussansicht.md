...
Выводы устройств на трехмерных размещениях изделий можно отобразить в пространстве листа графически. Таким образом, можно быстрее и проще оценить, подходит ли их позиция и направление вывода для имеющихся сегментов маршрутизации и кабельных каналов, благодаря чему [маршрутизируемые соединения](Glossary_o_verlegeverbindungen.md) смогут безошибочно найти [выводы устройства](Glossary_o_anschluesse.md). Если это не так, необходимо изменить направление вывода или расположение сегментов маршрутизации.

В графическом просмотре нельзя удалять, перемещать или дублировать выводы [устройства](Glossary_o_betriebsmittel.md). Данные выводов устройства изменяются в диалоговом окне 'Свойства' размещения изделия.
