...
* XGedIaFormatDefPoints: Настройка формата графики [соединения](Glossary_o_verbindungen.md) (точка определения соединения, точка определения потенциала)
...
* 0 = деактивировать [настройки](Glossary_o_einstellungen.md) для блока выравнивания
...
/propertyId:? |  Идентификатор определяемого [свойства](Glossary_o_eigenschaften.md) условного [обозначения](Glossary_o_bezeichnungen.md) (= номер свойства).
...
* 4 = обзор
* 5 = графика
* 6 = [компоновка электрошкафа](Glossary_o_schaltschrankaufbau.md)
* 7 = [функциональная схема автоматизации](Glossary_o_ri_fliessbild.md)
* 8 = многополюсный Fluid
* 9 = [топология](Glossary_o_topologie.md)
