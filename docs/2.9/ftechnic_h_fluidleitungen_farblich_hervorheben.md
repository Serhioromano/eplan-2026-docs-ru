...
Ниже на конкретном примере описано, как при такой стандартной настройке изменить тип трубопровода у соединения Fluid-техники и в связи с этим — цвет, присвоив целям соединения Fluid-техники другие свойства выводов [устройства](Glossary_o_betriebsmittel.md).
...
* Оба условных [обозначения](Glossary_o_bezeichnungen.md) соединены между собой линией автоматического соединения, которая по умолчанию представлена в оранжевом цвете, как рабочая линия.
...
3. В диалоговом окне Логическая схема выводов устройства на выводе устройства [функции](Glossary_o_funktionen.md) "2" измените значение для свойства Подвод давления / управляющий вывод устройства с "Не определено" на "Обратная линия".
4. Подтвердите ввод.
