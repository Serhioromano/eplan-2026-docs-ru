...
![](images/arrow.png) В строке состояния отображается требование "Выбрать конец кривой".

![](images/arrow.png) На курсоре отображается красная квадратная рамка захвата; при соприкосновении с курсором кривая выделяется более светлым оттенком.
2. Выберите нижний конец кривой для изменения.

![](images/routing_modcurvetang2_as.png)

![](images/arrow.png) В строке состояния отображается требование "Выбрать ребро для тангенциального выравнивания".
3. Выберите вертикальный край объекта.

![](images/routing_modcurvetang3_as.png)

![](images/arrow.png) Направление кривой в области нижнего конца кривой закругляется и выравнивается по касательной по вертикальному краю.

![](images/routing_modcurvetang4_as.png)

![](images/arrow.png) Затем можно изменить направления других кривых.
