...
Вы открыли навигатор страниц и открыли (как минимум) один проект. Выберите команду Копировать из / в. (Для этого вам нужно сначала [Настроить ленту](eplan/userinterface_h_menuebandanpassen.md) и присвоить нужную команду определенной пользователем группе команд.)
