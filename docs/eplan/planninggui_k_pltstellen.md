...
Символ |  Значение
---|---
![](images/planninggui_safetyrelevant_as.png) |  Релевантно для безопасности
![](images/planninggui_gmprelevant_as.png) |  Относится к GMP
(GMP означает "Good Manufacturing Practice" = Надлежащая практика организации производства).
![](images/planninggui_qualityrelevant_as.png) |  Релевантно для качества
