...
Часть номера ТК задается при копировании и вставке технологических контуров в соответствии с [конфигурацией](eplan/planninggui_d_konfigsegmentdef.md#RegisterkarteVerfuegbarkeit) определений сегмента. В навигаторе предварительного планирования и в диалоговом окне Свойства можно повторно пронумеровать технологические контуры. Другие части номера ТК (например, измеряемая величина) учитываются при нумерации, только если эти свойства заданы в [настройках нумерации](eplan/planninggui_d_einstellpltstellen.md) как идентифицирующие.
