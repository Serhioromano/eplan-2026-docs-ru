...
Выберите здесь параметр **Eplan** и нажмите на ![](images/all_selectfile_as.png), чтобы выбрать файл базы данных `*.db` при помощи диалогового окна выбора файла.
...
Кнопка ![](images/all_new_as.png) (Создать) рядом с полями **Eplan** и **Сервер SQL** дает вам возможность создать новый словарь.
