...
Этот список содержит возможные главные узлы для конфигурации. Нажмите на кнопку ![](images/all_edit_as.png) (Обработать) для выделенной строки главного узла, чтобы задать подробные настройки для соответствующей конфигурации в диалоговом окне **Конфигурация дерева — Главные узлы**.
