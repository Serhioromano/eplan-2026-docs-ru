...
!!! example "Пример:"
    ...
    Для второго варианта**Вверху**это означает: Смотря сверху, первая цель находится внизу, вторая цель слева и третья находится справа. Смотря слева, справа и снизу цель находится соответственно сверху.
