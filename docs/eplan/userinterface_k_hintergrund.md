...
[![](images/userinterface_ribbon_structure_ls_thumb_0_60.png)](../Pictures/Gui/Lang/userinterface_ribbon_structure_ls.png)
...
* Пиктограмма ошибки ![](images/erroricon_error_systemmessages.png): если с момента последнего открытия диалогового окна системных сообщений ошибка возникает снова, в правой части строки состояния появится эта пиктограмма. В правом нижнем углу экрана на несколько секунд появится уведомление. Щелкнув по пиктограмме или гиперссылке в уведомлении, вы перейдете к диалоговому окну системных сообщений. После того, как вы прочитаете системное сообщение и закроете диалоговое окно, пиктограмма исчезнет.
* Прямая обработка ![](images/inplaceeditinggui_icon_as.png): при включенном режиме обработки Прямая обработка в правой части строки состояния будет отображена эта пиктограмма.
