...
!!! info "Для сведения:"
    ...
    В списке Свойства отображается свойство Число функций. В противном случае дополните список при помощи кнопки ![](images/all_new_as.png) (Создать), введя это свойство.
