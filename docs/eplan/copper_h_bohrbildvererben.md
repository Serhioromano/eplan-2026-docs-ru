...
### [Унаследовать схему сверления автоматически](javascript:void\(0\);)
...
### [Унаследовать схему сверления вручную](javascript:void\(0\);)
...
### [Обновить наследование](javascript:void\(0\);)
...
[Диалоговое окно Настройки: Изгиб шины (пользователь)](cabinetgui_d_einstellungenkupferbiegungbenutzer.htm)
