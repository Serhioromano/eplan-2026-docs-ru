...
Обновить макросы |  Открывает диалоговое окно Обновить макросы, в котором можно выполнить настройку обновления. Затем выделенные в проекте ссылающиеся или незаданные макросы [обновляются](macrosgui_h_makrokasten.htm#I_MakroTauschen) с помощью данных из соответствующих файлов макросов.  
...
[Расширить объекты-заполнители](macrosgui_h_platzhalterobjekteerweitern.htm)
