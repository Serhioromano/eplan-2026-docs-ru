...
![](images/all_folder_closed.png) |  Каталог (согласно пути, указанному в имени макроса)
![](images/navigatorgui_usageundetermined_as.png) |  "Незаданные" или "нижестоящие" макросы
![](images/navigatorgui_usagedefinitive_as.png) |  Определяющие макросы
![](images/navigatorgui_usagereferenced_as.png) |  Ссылающиеся макросы
![](images/navigatorgui_macrowindow_as.png) |  Макрос окна
![](images/navigatorgui_macrosymbol_as.png) |  Макрос символа
![](images/navigatorgui_macropage_as.png) |  Макрос страницы
(напр., ![](images/pagebrowsergui_pagemultipole_as.png)) |

* Макросы окон и символов: Вид представления рамки макроса (здесь, например, многополюсный)
* Макросы страницы: Тип страницы

![](images/cabinetgui_layoutspace_as.png) |  3D-макросы: Пространство листа
![](images/navigatorgui_macro_as.png) |  Вариант макроса
![](images/cabinetgui_placeholder_as.png) |  Объект-заполнитель
...
!!! note "Замечание:"
    ...
    * На уровне иерархии с видом представления / типом страницы для подготовленных 3D-макросов отображается пиктограмма пространства листа ![](images/cabinetgui_layoutspace_as.png) с текстом "Трехмерный чертеж монтажных поверхностей". При генерации макросов 3D-макросам автоматически присваивается вид представления "Трехмерный чертеж монтажных поверхностей".
