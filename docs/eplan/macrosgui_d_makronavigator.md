...
Обновить макросы |  Открывает диалоговое окно Обновить макросы, в котором можно выполнить настройку обновления. Затем выделенные в проекте ссылающиеся или незаданные макросы [обновляются](macrosgui_h_makrokasten.md#I_MakroTauschen) с помощью данных из соответствующих файлов макросов.  
