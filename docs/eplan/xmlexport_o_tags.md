...
463 |  P_ARTICLE_MAX_RATED_POWER | Текст (значение с единицей измерения) | Мощность | kW | Номинальная мощность (в к Вт), макс.
464 |  P_ARTICLE_RATED_POWER_MIN | Текст (значение с единицей измерения) | Мощность | kW | Номинальная мощность (в к Вт), мин.
