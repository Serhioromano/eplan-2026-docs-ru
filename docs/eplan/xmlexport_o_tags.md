...
Для атрибутов и списков выбора допускается использование только определенных значений, полученных из базы данных изделий. Обзор доступных значений приводится в [соответствующем разделе](eplan/xmlexport_o_sellists.md).
...
506 |  P_ARTICLE_PRODUCTGROUP | Long (список выбора) |  |  | [Группа продуктов](eplan/xmlexport_o_productgroups.md#P_ARTICLE_PRODUCTGROUP)  
507 |  P_ARTICLE_PRODUCTTOPGROUP | Long (список выбора) |  |  | [Главная группа продуктов](eplan/xmlexport_o_productgroups.md#P_ARTICLE_PRODUCTTOPGROUP)  
508 |  P_ARTICLE_PRODUCT_TYPE | Текст (многоязычный) |  |  | Тип продукта  
509 |  P_ARTICLE_PRODUCTSUBGROUP | Long (список выбора) |  |  | [Подгруппа продуктов](eplan/xmlexport_o_productgroups.md#P_ARTICLE_PRODUCTSUBGROUP)  
...
([Список выбора](eplan/xmlexport_o_sellists.md#characteristics)) |  Цвет / номер соединения |  Экранировано от |  Парный индекс |  Поперечное сечение / диаметр соединения  
