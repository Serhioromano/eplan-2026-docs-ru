...
Для атрибутов и списков выбора допускается использование только определенных значений, полученных из базы данных изделий. Обзор доступных значений приводится в [соответствующем разделе](xmlexport_o_sellists.htm).
...
506 |  P_ARTICLE_PRODUCTGROUP | Long (список выбора) |  |  | [Группа продуктов](xmlexport_o_productgroups.htm#P_ARTICLE_PRODUCTGROUP)  
507 |  P_ARTICLE_PRODUCTTOPGROUP | Long (список выбора) |  |  | [Главная группа продуктов](xmlexport_o_productgroups.htm#P_ARTICLE_PRODUCTTOPGROUP)  
508 |  P_ARTICLE_PRODUCT_TYPE | Текст (многоязычный) |  |  | Тип продукта  
509 |  P_ARTICLE_PRODUCTSUBGROUP | Long (список выбора) |  |  | [Подгруппа продуктов](xmlexport_o_productgroups.htm#P_ARTICLE_PRODUCTSUBGROUP)  
...
([Список выбора](xmlexport_o_sellists.htm#characteristics)) |  Цвет / номер соединения |  Экранировано от |  Парный индекс |  Поперечное сечение / диаметр соединения  
