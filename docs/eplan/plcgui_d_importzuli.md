...
!!! note "Замечание:"
    ...
    Вы можете импортировать всякий раз только отдельный список для каждого процессора (ЦПУ). Поэтому в диалоговом окне Адреса / Списки присвоений настройте фильтр так, чтобы отображались только адреса ПЛК одного ЦПУ. В качестве альтернативы вы можете импортировать адреса ПЛК в новое ЦПУ.

### Имя файла:

В этом поле выводится имя файла списка присвоений, которое было выбрано для импорта. С помощью ![](images/all_selectfile_as.png) откройте диалоговое окно выбора файла, где можно выбрать другой список присвоений.
