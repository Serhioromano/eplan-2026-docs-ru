...
В этом поле выводится имя файла списка присвоений, которое было выбрано для импорта. С помощью ![](images/all_selectfile_as.png){ .ui-icon } откройте диалоговое окно выбора файла, где можно выбрать другой список присвоений.
