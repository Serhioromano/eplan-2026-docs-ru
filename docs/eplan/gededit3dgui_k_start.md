...
!!! example "Пример:"
    ...
    (1): Вид на косую поверхностьбезактивированногосвойства Обзор модели: Занять точку наблюдения за монтажной поверхностьюи результат в обзоре модели(2): Вид на косую поверхностьсактивированным свойством Обзор модели: Занять точку наблюдения за монтажной поверхностьюи результат в обзоре модели
