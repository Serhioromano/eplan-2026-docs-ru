...
!!! note "Замечание:"
    ...
    С помощью пункта всплывающего меню Новое устройствотакже можно выбирать изделия из главной группы продуктов "Механика" и создавать их в качестве устройства. При этом создается механическое устройство с неразмещенными механическими функциями. С помощью пунктов меню Создатьи Новые функцииневозможногенерироватьмеханические функции, т. к. создание механических функций без изделий нецелесообразно.
