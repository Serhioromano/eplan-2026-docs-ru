...
Для ввода пересечения выберите следующие команды: вкладка **Вставить** > группа команд **Символы** > ![](images/ribbon_junction_as.png) ( **Пересечение**). (С помощью кнопки ![](images/ribbon_galleryfurther_as.png) (Другие) также можно увеличить поле с символами и под полем **Соединители** выбрать кнопку для пересечения.) Символ ответвления появится рядом с курсором, и его можно будет разместить на странице. При помощи кнопки ++"Tab"++ можно пролистать имеющиеся варианты. Само ответвление от прямого или зигзагообразного соединения обозначается в символе стрелкой. Диалоговое окно Свойства для пересечений не предусмотрено.
