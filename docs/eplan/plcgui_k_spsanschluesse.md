...
Для всех систем шин. В системе шин на базе Ethernet выводы устройства должны иметь одинаковое имя интерфейса шины. Имя интерфейса шины не должно быть пустым. Введите данные только на главном выводе шины. С помощью контрольного прогона [004040](msg/messages_p_004040.md) можно найти противоречивые данные.
...
!!! note "Замечание:"
    ...
    При обмене данными ПЛК в формате AutomationML AR APC выводы шины внутри одной и той же системы шин и одной и той же физической сети (свойство Физическая сеть: Имя) считаются связанными, даже если они имеют разные ОУ. Однако это не видно при отслеживании сети. Контрольный прогон [004104](msg/messages_p_004104.md) сообщает о таких соединениях шин как несвязанных между собой. Это сообщение можно проигнорировать, если вы намеренно спроектировали структуру сети таким образом из-за физических условий.
