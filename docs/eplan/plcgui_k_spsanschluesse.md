...
!!! note "Замечание:"
    ...
    При обмене данными ПЛК вформате AutomationML AR APCвыводы шинывнутри одной и той же системы шин и одной и той же физической сети (свойство Физическая сеть: Имя) считаются связанными, даже если они имеют разные ОУ. Однако это не видно при отслеживании сети. Контрольный прогон004104сообщает о таких соединениях шин как несвязанных между собой. Это сообщение можно проигнорировать, если вы намеренно спроектировали структуру сети таким образом из-за физических условий.
