...
1. Выберите следующие команды: Вкладка Вставить > группа команд Устройства > (Монтажная плата).
...
5. Выберите пункт всплывающего меню Опции размещения, чтобы открыть диалоговое окно [Опции размещения](eplan/cabinetgui_d_platzieroptionen.md). Здесь можно задать смещение точки захвата относительно позиции курсора, а также использовать все возможности настроек для многократного размещения монтажных плат.
...
1. Выберите следующие команды: Вкладка Вставить > группа команд Устройства > (Произвольная монтажная плата).
