...
![](images/arrow.png) Чертится линия с размерами, а числовая мера размещается на фрагменте по центру. Высота, на которой чертятся следующие линии с размерами, определяется стандартом DIN.
