...
!!! note "Замечание:"
    ...
    Записи, которые можно сделать в поле Тип файла, имеют следующее значение:XML-файл (*.etd): Этот формат используется для внутреннего обмена данными Eplan P8.Файл в формате Юникод с разд. табуляцией (*.txt): Этот формат используется для "внешнего" обмена данными, например с Excel.
