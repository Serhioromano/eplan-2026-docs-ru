...
![](images/arrow.png) Будет выведен запрос выбора источника/цели маршрутизируемых соединений.
2. Укажите две угловые точки прямоугольника, который охватывает нужные объекты.

![](images/routing_entrynet1b_as.png)

![](images/arrow.png) Выбранные источники / цели будут помечены цветом.

![](images/arrow.png) Отобразится запрос выбора кабельного канала или сегмента маршрутизации, через который соединение должно входить в сеть соединенных сегментов.
...
![](images/arrow.png) Отобразится диалоговое окно **Соединения**, в котором перечислены все соединения, содержащиеся в выбранном источнике. Соединения, охваченные при выборе источника и цели, уже выделены в диалоговом окне.
...
![](images/arrow.png) Выбранные соединения будут направлены в выбранную точку вхождения в сеть соединенных сегментов и маршрутизированы заново.
