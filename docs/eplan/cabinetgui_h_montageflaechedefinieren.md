...
![](images/arrow.png) Если за рамками выбранной поверхности в той же плоскости будут найдены и другие поверхности, отобразится сообщение.

![](images/arrow.png) Дополнительно найденные поверхности в данной плоскости подсветятся желтым.
...
![](images/arrow.png) Выбранная поверхность будет определена как монтажная поверхность. В навигаторе пространства листа под соответствующим узлом функционального элемента генерируется запись Монтажная поверхность.

![](images/arrow.png) Отобразится диалоговое окно **Свойства** данной монтажной поверхности, и в нем можно задать описание функциональных элементов и выбрать дальнейшие свойства.
...
1. Выберите команду для вставки изделия (например, вкладку **Вставить** > группа команд **Устройства** > ![](images/ribbon_mountingpanel_as.png) ( **Монтажная плата**) или, например, **Центр вставки** > строка навигации **Главная** > **Устройства**).
2. Переместите курсор в область трехмерного тела.

![](images/arrow.png) Расположенная под курсором поверхность не выделяется цветом, если на ней не определена монтажная поверхность.
...
![](images/arrow.png) Все монтажные поверхности на функциональном элементе генерируются в соответствии с выбранным определением функции и вводятся с соответствующими обозначениями функционального элемента в навигатор пространства листа.
