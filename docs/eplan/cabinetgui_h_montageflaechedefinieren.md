...
1. Выберите команду для вставки изделия (например, вкладку **Вставить** > группа команд **Устройства** > ![](images/ribbon_mountingpanel_as.png){ .ui-icon } ( **Монтажная плата**) или, например, **Центр вставки** > строка навигации **Главная** > **Устройства**).
2. Переместите курсор в область трехмерного тела.
