...
[![](images/routinggui_wiringmanager_ls_thumb_0_60.png)](images/routinggui_wiringmanager_ls.png)
...
![](images/link_helpsystem_book.png){ .ui-icon }[Управление маршрутизируемыми соединениями](routinggui_k_verdrahtungsmanager.md)

![](images/link_helpsystem_book.png){ .ui-icon }[Диалоговое окно "Диспетчер разводки"](routinggui_d_verdrahtungsmanager.md)
