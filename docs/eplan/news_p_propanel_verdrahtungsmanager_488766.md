...
[![](images/routinggui_wiringmanager_ls_thumb_0_60.png)](../Pictures/Gui/Lang/routinggui_wiringmanager_ls.png)
...
![](images/link_helpsystem_book.png)[Управление маршрутизируемыми соединениями](routinggui_k_verdrahtungsmanager.md)

![](images/link_helpsystem_book.png)[Диалоговое окно "Диспетчер разводки"](routinggui_d_verdrahtungsmanager.md)
