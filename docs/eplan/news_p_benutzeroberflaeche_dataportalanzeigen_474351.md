...
Теперь пиктограмма ![](images/userinterface_edpIcon_as.png){ .ui-icon } "Data Portal" отображается в дереве управления изделиями и в центре вставки. В древовидной структуре и в комбинированном представлении в управлении изделиями эта пиктограмма находится над узлом изделия, а в центре вставки — под пиктограммой ![](images/insertergui_macro_as.png){ .ui-icon } "Макросы окна / символа".
...
Теперь при поиске в центре вставки по умолчанию — если это возможно — также выполняется поиск в Eplan Data Portal. Для этого фильтр поиска ![](images/insertergui_search_in_all_as.png){ .ui-icon } (Поиск во всех разделах) дополнен поиском в Eplan Data Portal. Дополнительно доступны следующие новые фильтры поиска:
...
Чтобы поиск в центре вставки выполнялся также в Eplan Data Portal, необходимо активировать один из фильтров поиска ![](images/insertergui_search_in_all_as.png){ .ui-icon } (Поиск во всех разделах) или ![](images/insertergui_search_in_device_and_DP_as.png) (Поиск в устройствах и Data Portal) перед полем Поиск.
