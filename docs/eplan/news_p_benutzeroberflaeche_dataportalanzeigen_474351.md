...
[](../Pictures/Gui/Lang/articlesgui_dataportaltab_ls.png)
...
Чтобы пиктограммы Eplan Data Portal отображались и вы могли использовать Eplan Data Portal, необходимо зарегистрироваться в Eplan Cloud. Дополнительную информацию об облачных продуктах Eplan Cloud см. в справке по [Eplan Cloud](../../../../Cloud/Content/htm/Cloud_k_home.htm).
...
[Диалоговое окно Настройки: Предварительная фильтрация изделий](partsextensiongui_d_artikelvorfilterung.htm)
