...
[![](images/articlesgui_dataportaltab_ls_thumb_0_60.png)](../Pictures/Gui/Lang/articlesgui_dataportaltab_ls.png)
...
Чтобы пиктограммы Eplan Data Portal отображались и вы могли использовать Eplan Data Portal, необходимо зарегистрироваться в Eplan Cloud. Дополнительную информацию об облачных продуктах Eplan Cloud см. в справке по [Eplan Cloud](../../../../Cloud/Content/htm/Cloud_k_home.md).
