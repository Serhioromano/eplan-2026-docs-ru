...
Вы выбрали один или несколько подготовленных или добавленных макросов с [методом использования](macrosgui_k_makrokaesten.md#I_Verwendungsart) "Ссылающийся" или "Не задан". В соответствующих рамках макроса метод использования задается с помощью одноименного раскрывающегося списка.
