...
Eplan открывает диалоговое окно [Сохранить как](eplan/macrosgui_d_speichernunter.md). Имя файла и вариант макроса заданы по умолчанию.
...
Вы выбрали один или несколько подготовленных или добавленных макросов с [методом использования](eplan/macrosgui_k_makrokaesten.md#I_Verwendungsart) "Ссылающийся" или "Не задан". В соответствующих рамках макроса метод использования задается с помощью одноименного раскрывающегося списка.
...
3. В поле Настройки диалогового окна Обновить макросы выберите из раскрывающегося списка подходящую схему. Либо щелкните по [...], чтобы открыть диалоговое окно [Настройки: Обновить макросы](eplan/gedviewer_d_einstellungenmakrosaktualisieren.md). Здесь можно посмотреть настройки выбранной схемы, создать и обработать собственные схемы.
