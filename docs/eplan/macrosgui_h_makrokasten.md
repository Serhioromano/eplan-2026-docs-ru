...
!!! note "Замечание:"
    ...
    При обновлении из переработанного макроса в проект также копируются измененные данные вкладки Рамка макроса. Помимо свойств Имя,Вид представленияи Вариант, также копируются значения следующих защищенных от записи свойств:
