...
[Вызов диалогового окна навигатора пространства листа:](javascript:void\(0\);)
...
[Вызов диалогового окна для других диалоговых окон с 3D-объектами:](javascript:void\(0\);)
...
Обновить главные элементы |  [Обновить главные элементы](eplan/cabinetgui_h_hauptbauteileaktualisieren.md)  
Обновить размещение изделия |  [Обновить размещение изделия](eplan/cabinetgui_h_artikelabmessungenaktualisieren.md)  
Заменить изделия |  [Заменить изделия в размещенных изделиях](eplan/cabinetgui_h_artikeltauschen.md)  
Обработать позицию легенды |  [Обработать позицию легенды](eplan/cabinetgui_h_legendenpositionbearbeiten.md)  
...
Прямая активация (только монтажные поверхности) |  [Активировать монтажные поверхности](eplan/cabinetgui_h_aktivierenautomatisch.md#I_GezieltAktivieren)  
Отмена прямой активации |  [Отмена прямой активации](eplan/cabinetgui_h_aktivierenautomatisch.md#I_Aktivierungaufheben)  
...
Упрощенное представление |  [Упрощенное представление](eplan/cabinetgui_h_bauraumansichten.md#I_BauraumVereinfachteDarstellung) для клеммников и 3D-макросов  
...
Монтажная поверхность (только монтажные поверхности) > Выровнять ось X / Выровнять ось Y |  [Выровнять ось X / Y монтажной поверхности](eplan/cabinetgui_h_xyachseausrichten.md)  
Монтажная поверхность (только монтажные поверхности) > изменить размер |  [Изменить размер монтажной поверхности](eplan/cabinetgui_h_mfgroesseaendern.md)  
Размер поля (только монтажные поверхности) |  [Определить размер поля](eplan/cabinetgui_h_feldgroesseaendern.md)  
...
* [Диалоговое окно Свойства (усл. обозначение): Пространство листа](eplan/cabinetgui_d_bauraumeigenschaften.md)
* [Диалоговое окно Трехмерный навигатор монтажных поверхностей](cabinetgui_d_navigator3dschaltschrankaufbau.htm)
