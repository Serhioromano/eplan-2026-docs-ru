...
!!! note "Замечание:"
    ...
    Для трех диалоговых окон Пространство листа — <Имя проекта>,Выбор 3D-объектаи Отобразить / скрыть 3D-объектыиспользуется одинаковая конфигурация. При изменении конфигурации представления в виде дерева или списка для одного из этих диалоговых окон это будет иметь действие сразу на все три диалоговых окна.
