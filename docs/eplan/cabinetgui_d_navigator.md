...
Обновить главные элементы |  [Обновить главные элементы](cabinetgui_h_hauptbauteileaktualisieren.htm)  
Обновить размещение изделия |  [Обновить размещение изделия](cabinetgui_h_artikelabmessungenaktualisieren.htm)  
Заменить изделия |  [Заменить изделия в размещенных изделиях](cabinetgui_h_artikeltauschen.htm)  
Обработать позицию легенды |  [Обработать позицию легенды](cabinetgui_h_legendenpositionbearbeiten.htm)  
...
Прямая активация (только монтажные поверхности) |  [Активировать монтажные поверхности](cabinetgui_h_aktivierenautomatisch.htm#I_GezieltAktivieren)  
Отмена прямой активации |  [Отмена прямой активации](cabinetgui_h_aktivierenautomatisch.htm#I_Aktivierungaufheben)  
...
Упрощенное представление |  [Упрощенное представление](cabinetgui_h_bauraumansichten.htm#I_BauraumVereinfachteDarstellung) для клеммников и 3D-макросов  
...
Монтажная поверхность (только монтажные поверхности) > Выровнять ось X / Выровнять ось Y |  [Выровнять ось X / Y монтажной поверхности](cabinetgui_h_xyachseausrichten.htm)  
Монтажная поверхность (только монтажные поверхности) > изменить размер |  [Изменить размер монтажной поверхности](cabinetgui_h_mfgroesseaendern.htm)  
Размер поля (только монтажные поверхности) |  [Определить размер поля](cabinetgui_h_feldgroesseaendern.htm)  
...
[Адаптировать структуру пространства листа](cabinetgui_h_bauraumstrukturanpassen.htm)

[Диалоговое окно Свойства (усл. обозначение): Пространство листа](cabinetgui_d_bauraumeigenschaften.htm)
