...
Прямая активация (только монтажные поверхности) |  [Активировать монтажные поверхности](cabinetgui_h_aktivierenautomatisch.md#I_GezieltAktivieren)  
Отмена прямой активации |  [Отмена прямой активации](cabinetgui_h_aktivierenautomatisch.md#I_Aktivierungaufheben)  
...
Упрощенное представление |  [Упрощенное представление](cabinetgui_h_bauraumansichten.md#I_BauraumVereinfachteDarstellung) для клеммников и 3D-макросов  
