...
!!! example "Пример:"
    ...
    Следующий пример демонстрирует сценарий на C#, через который можно активировать настройкуОтображать идентифицирующие номера:public class SetSettingScript
{
