...
Вы открыли проект.
  ...
  * Вкладка Устройства > группа команд Штекеры > Навигатор
  * Вы открыли редактор, например графический редактор, редактор рамок и т. д. Вкладка Вид > группа команд Навигаторы > раскрывающаяся кнопка Открыть > Штекеры
