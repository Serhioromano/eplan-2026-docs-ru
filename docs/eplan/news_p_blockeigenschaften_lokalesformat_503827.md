...
[](../Pictures/Gui/Lang/eservicesgui_userpropertiesdialog_localformat_ls.png)
...
* [Группы единиц измерения для свойств типа поля "Значение с единицей измерения"](news_p_eigenschaften_einheitengruppen_471994.htm)
