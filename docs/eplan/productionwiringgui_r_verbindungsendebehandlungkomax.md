...
![](images/all_update_as.png){ .ui-icon } (Обновить) |  Перечитывает обработку концов проводов, назначенную для соответствующих категорий соединений, из соединений в проекте. Информация вводится в столбец **Обработка концов проводов**.
