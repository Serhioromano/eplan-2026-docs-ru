...
!!! tip "Совет:"
    ...
    В проекте макросов можно автоматически группировать макросы перед генерацией и / или автоматически активировать точки захвата. Выберите для этого следующие команды: вкладка **Основные данные** > группа команд **Макросы** > раскрывающаяся кнопка **Генерировать автоматически** > [Подготовить макросы к автоматической генерации](macrosgui_d_makrosvorbereiten.md).
...
![](images/arrow.png) Обозначенные рамками макросов области сохраняются как макросы окон и / или символов в указанный при настройке каталог макросов. При этом для необходимых данных используются свойства рамки макроса.

![](images/arrow.png) Результат автоматического генерирования отображается в диалоговом окне **Системные сообщения**.
...
![](images/arrow.png) Макросы страницы ( `*.emp`) сохраняются в указанный каталог макросов. При этом для необходимых данных используются свойства страницы.
