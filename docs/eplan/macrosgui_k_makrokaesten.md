...
Если при подготовке макроса для настройки Вставить также рамку макроса выбран параметр "Из настроек проекта", для всего проекта схемы соединений можно указать, что рамки макросов также вставляются. Для этого активируйте настройку проекта [Вставить также рамки макросов](gedviewer_d_einstellungenprojektallgemein.md#MakrokaestenMitEinfuegen).
...
Кроме того, [метод использования](macrosgui_r_makrokasten.md#Verwendungsart) позволяет лучше различать подготовленные макросы в навигаторе макросов.
