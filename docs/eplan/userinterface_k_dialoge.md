...
!!! note "Замечание:"
    ...
    * Диалоговые окна Обзор свойств, База данных изделий и Выбор изделия подобно навигаторам представляют данные в виде списков или древовидных структур и также обладают диалоговой памятью.
