...
В настройках пользователя можно сохранить пять разных шагов сетки; их можно выбрать в пространстве листа с помощью раскрывающейся кнопки ![](images/all_gridactive_as.png){ .ui-icon } (Сетка) в строке состояния. Настройка возможна для 2D и 3D раздельно.
...
1. Нажмите в строке состояния графического редактора на кнопку ![](images/statusbar_snaptogrid_as.png){ .ui-icon } (Вкл. / выкл. захват сетки), чтобы включить и выключить использование захвата сетки.
