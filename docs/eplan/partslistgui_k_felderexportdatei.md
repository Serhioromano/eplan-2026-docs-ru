...
P_DESIGNATION_PLANT |  Функциональное назначение (главный идентификатор)  
P_DESIGNATION_FULLPLANT |  Функциональное назначение  
P_DESIGNATION_LOCATION |  Место установки (главный идентификатор)  
...
[Экспортировать спецификации](partslistgui_h_stuecklistenexportieren.htm)

[Импортировать спецификации](partslistgui_h_stuecklistenimportieren.htm)
