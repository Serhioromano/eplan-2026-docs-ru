...
!!! note "Замечание:"
    ...
    При экспорте с помощью пункта меню Экспорт списка отсутствующих слов в качестве исходного языка используется тот язык, который установлен в качестве исходного языка в [пользовательских настройках перевода](modaldialogs_r_einstellungprojekt.md) на вкладке Общее.
