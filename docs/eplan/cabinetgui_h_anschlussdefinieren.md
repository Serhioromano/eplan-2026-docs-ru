...
6. Во всплывающем меню выберите пункт [Опции размещения](eplan/cabinetgui_d_platzieroptionen.md), чтобы задать размещению вывода устройства смещение по осям X, Y и Z.
...
8. Если вывод устройства необходимо обратить в другом направлении, измените значения вектора. Примеры этих действий приведены [здесь](eplan/devicetaggui_r_anschlussbild.md#XYZVektor).
