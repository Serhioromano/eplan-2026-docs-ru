...
Удерживая клавишу [Ctrl], вы можете щелкнуть мышью на две точки, чтобы установить середину между этими точками. Так вывод устройства можно разместить также в центре в прямоугольных отверстиях.
  6. Во всплывающем меню выберите пункт [Опции размещения](cabinetgui_d_platzieroptionen.htm), чтобы задать размещению вывода устройства смещение по осям X, Y и Z.
...
[Вкладка Схема соединений (Размещение изделия 3D)](devicetaggui_r_anschlussbild.htm)

[Показать выводы устройства графически](routinggui_h_anschlussansicht.htm)

[Перенос локальной схемы соединений в базу данных изделий](cabinetgui_h_anschlussbildnachartvw.htm)
