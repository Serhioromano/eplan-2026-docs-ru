...
Если Захват объекта активирован в строке состояния с помощью кнопки  (Вкл. / выкл. захват объекта), эти точки будут использоваться как точки захвата. В этом случае графические объекты при вставке автоматически привязываются к этим точкам захвата.
...
С помощью этих функций можно начертить перпендикуляр или касательную линию. Если во всплывающем меню выбран один из этих режимов, у курсора меняется пиктограмма. Соответствующие режимы при этом доступны для следующих графических элементов:
  ...
  * Режим черчения "Перпендикуляр" (курсор: ): для линий, ломаных линий и многоугольников
  * Режим черчения "Касательная" (курсор: ): для линий, ломаных линий, многоугольников, окружностей, дуг по центру и секторов.
...
[Активировать захват объекта](gededitgui_h_fangpunkte.htm)

[Начертить перпендикулярные или касательные линии](gededitgui_h_lotrechttangentialzeichnen.htm)
