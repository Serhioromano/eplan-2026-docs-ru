...
Если Захват объекта активирован в строке состояния с помощью кнопки ![](images/statusbar_objectsnap_as.png) (Вкл. / выкл. захват объекта), эти точки будут использоваться как точки захвата. В этом случае графические объекты при вставке автоматически привязываются к этим точкам захвата.
...
* Режим черчения "Перпендикуляр" (курсор: ![](images/gededitgui_vertically_as.png)): для линий, ломаных линий и многоугольников
* Режим черчения "Касательная" (курсор: ![](images/gededitgui_tangential_as.png)): для линий, ломаных линий, многоугольников, окружностей, дуг по центру и секторов.
