...
!!! note "Замечание:"
    ...
    Чтобы провести соединение через уже размещенное крепление кабеля / шланга, необходимо проложить соединение с помощью командыИзменить маршрутизацию(вкладкаОбработать> группа командМаршрутизируемые соединения) через крепление как целевой сегмент маршрутизации.
