...
![](images/arrow.png) Расстояние от начальной точки к центру угла составляет в итоге высоту линии с размерами.
4. Разверните угол против часовой стрелки и укажите конечную точку.

![](images/arrow.png) По умолчанию числовая мера выравнивается на линии с размерами по центру.
