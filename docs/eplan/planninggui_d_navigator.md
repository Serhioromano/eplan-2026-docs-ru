...
!!! note "Замечание:"
    ...
    Учтите, что приконфигурациипредставления структуры деревав диалоговом окне Конфигурировать представлениепредставление сегментовнеконфигурируется; можно только определить свойства, которые должны отображаться в дереве для других объектов (проектов, функций, обозначений местоположения, определений трубопроводов и т. д.). Сегменты задаются в диалоговом окне Конфигурировать определения сегментас помощью поля Формат отображения навигаторав том же виде, в котором они представлены в дереве навигатора предварительного планирования.
