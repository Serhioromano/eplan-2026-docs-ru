...
Нумеровать технологические контуры |  Нумерует выбранные в навигаторе технологические контуры заново. При этом настройки для нумерации используются на вкладке Нумерация / доступность диалогового окна [Конфигурировать определения сегмента](planninggui_d_konfigsegmentdef.md#RegisterkarteVerfuegbarkeit).  
