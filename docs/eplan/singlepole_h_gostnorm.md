...
3. Выберите следующие команды: Вкладка **Вставить** > группа команд **Символы**. С помощью кнопки ![](images/ribbon_galleryfurther_as.png) (Другие) увеличьте поле с символами и выберите символ соединения ![](images/ribbon_bundleconnpointangle_as.png) (угол вывода жгута) под полем **Выводы жгута**.

![](images/arrow.png) Вывод жгута типа "Угол" прикрепляется к курсору.
4. Нажмите клавишу ++"Ctrl"++ и удерживайте ее нажатой.

![](images/arrow.png) Теперь с помощью круговых движений мыши можно настроить требуемый вариант угла.
...
![](images/arrow.png) Откроется диалоговое окно **Свойства** ++"..."++.
...
![](images/arrow.png) Диалоговое окно **Свойства** ++"..."++ закроется. Угол вставляется в схему соединений под клеммой 1.
...
![](images/arrow.png) Выполняется автоматическое соединение угла с клеммой PE / PEN. Далее толстые выводы углов объединяются в жгут.

![](images/singlepole_kabelstrangerstellen3_av.png)
13. Выберите следующие команды: Вкладка **Вставить** > группа команд **Символы**. С помощью кнопки ![](images/ribbon_galleryfurther_as.png) (Другие) увеличьте поле с символами и выберите символ соединения ![](images/ribbon_bundleconnpointtnode_as.png) \- (тройник вывода жгута) под полем **Выводы жгута**.
...
![](images/arrow.png) В результате получена следующая схема:
...
![](images/arrow.png) В результате получается следующая схема:

![](images/singlepole_kabelstrangerstellen5_av.png)
5. Выберите следующие команды: Вкладка **Вставить** > группа команд **Символы**. С помощью кнопки ![](images/ribbon_galleryfurther_as.png) (Другие) увеличьте поле с символами и выберите символ соединения ![](images/ribbon_bundleconnpointangle_as.png) (угол вывода жгута) под полем **Выводы жгута**.
...
![](images/arrow.png) При этом выполняется автоматическое соединение вывода жгута с выводом двигателя U1.
7. Щелкните левой кнопкой мыши.
...
![](images/arrow.png) Диалоговое окно **Свойства** ++"..."++ закроется. Угол вставляется в схему соединений над клеммой U1.
...
![](images/arrow.png) Выполняется автоматическое соединение угла с выводом PE / PEN. Далее толстые выводы обоих вставленных углов объединяются в жгут.
...
1. Выберите следующие команды: Вкладка **Вставить** > группа команд **Символы**. С помощью кнопки ![](images/ribbon_galleryfurther_as.png) (Другие) увеличьте поле с символами и выберите символ соединения ![](images/ribbon_bundleconnpointdistributor.png) \- (распределитель жгута, тройник) под полем **Выводы жгута**.
...
![](images/arrow.png) Между тройниками-распределителями образуется толстая линия автоматического соединения, т. е. Жгут.
