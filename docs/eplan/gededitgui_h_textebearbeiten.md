...
2. В диалоговом окне **Свойства (текст)** обрабатываются текст и его свойства. Используйте вкладки **Текст** и **Формат**, как описано в разделе "Вставить тексты".
3. Щелкните по кнопке ++"OK"++.

![](images/arrow.png) Изменения применяются и сразу же становятся видимы на странице.
