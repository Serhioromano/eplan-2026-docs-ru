...
В дереве навигатора макросов имеющиеся в макросе объекты-заполнители представлены под уровнем иерархии соответствующего варианта макроса (пиктограмма ). Доступен многократный выбор объектов-заполнителей, но групповая обработка возможна только при выполнении определенных [условий](eplan/macrosgui_h_platzhalterobjekteerzeugen.md#BlockbearbeitungPlatzhalterobjekte). С помощью всплывающего меню для объектов-заполнителей можно выбрать наборы значений и обработать их свойства.
