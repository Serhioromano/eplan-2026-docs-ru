...
3. Выберите следующие команды: Вкладка **Вставить** > группа команд **Логика** > ![](images/ribbon_wiringcombfront_as.png){ .ui-icon } ( **Гребенка для проводов, передняя сторона**).
...
6. Повторите процесс для определения монтажной поверхности с обратной стороны гребенки для проводов с помощью следующей команды: вкладка **Вставить** > группа команд **Логика** > раскрывающаяся кнопка ![](images/ribbon_wiringcombfront_as.png){ .ui-icon } ( **Гребенка для проводов, передняя сторона**) > **Гребенка для проводов, задняя сторона**.
...
9. Разместите гребенку для проводов в пространстве листа (например, на шине системы направляющих для проводов) с помощью следующих команд: вкладка **Вставить** > группа команд **Устройства** > ![](images/ribbon_userdefinedrail_as.png){ .ui-icon } ( **Пользовательская шина**). И растяните гребенку для проводов нужной длины.
