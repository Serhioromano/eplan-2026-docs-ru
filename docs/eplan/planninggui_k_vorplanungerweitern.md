...
!!! note "Замечание:"
    ...
    Если нижестоящие подструктуры для сегмента, в котором сохранен макрос, и нижестоящие подструктуры в макросе окна не совпадают, то структуры из макроса помещаются в существующую структуру предварительного планирования, но создаются новые сегменты. Они обозначены пиктограммой ![](images/all_statusnew_as.png).
