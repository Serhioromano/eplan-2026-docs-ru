...
1. Выберите следующие команды: Вкладка **Вставить** > группа команд **Помощь в маршрутизации** > **Соединительное отверстие для проводов**.

![](images/arrow.png) В строке состояния отобразится требование: "Начальная точка соединительного отверстия для проводов".
...
![](images/arrow.png) В строке состояния отобразится требование: 'Конечная точка соединительного отверстия для проводов'.
...
![](images/arrow.png) Соединительное отверстие для проводов вставляется в функциональный элемент в виде прямоугольного параллелепипеда.
