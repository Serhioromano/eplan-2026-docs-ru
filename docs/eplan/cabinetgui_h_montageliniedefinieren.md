...
Линии монтажа копируют [Направление Z](eplan/cabinetgui_h_anschlussdefinieren.md#ZRichtung) поверхности, выбранной в ходе определения. Направление Z указывает, как должен быть направлен размещаемый на линии монтажа объект.
