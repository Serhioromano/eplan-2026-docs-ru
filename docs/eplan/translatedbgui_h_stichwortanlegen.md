...
4. Чтобы создать ключевое слово, щелкните по кнопке ![](images/all_new_as.png) (Создать).

![](images/arrow.png) Eplan отобразит индикатор вставки в поле **Ключевое слово** в строке для текста перевода исходного языка.
...
8. Щелкните по кнопке ![](images/all_save_as.png) (Сохранить).

![](images/arrow.png) Ключевое слово будет добавлено в левую часть списка ключевых слов.
