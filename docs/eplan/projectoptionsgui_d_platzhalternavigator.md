...
!!! note "Замечание:"
    ...
    В отличие отимени, которое является идентифицирующим и поэтому не многоязычным,описаниеможно использовать для дополнительной информации, которую можно отобразить на иностранном языке. Соответствующий многоязычный текст вводится на вкладке Объект-заполнитель.
