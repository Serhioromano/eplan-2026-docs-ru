...
Эта функциональность предусмотрена только в определенных модулях расширения. [Информация / авторское право](license_k_start.md) Вы находитесь здесь:
...
В Eplan можно назначить эти взаимодействия [определенной пользователем группе команд в качестве команд](userinterface_h_menuebandanpassen.md), например, в ленте. Далее перечисляются параметры вышеназванных взаимодействий.
