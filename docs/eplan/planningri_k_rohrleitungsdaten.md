...
Единица измерения поперечного сечения / диаметра соединения применяется из предварительных настроек технологических соединений для всего проекта (Файл > Настройки > Проекты > "Имя проекта" > Соединения > Свойства; вкладка Технология производственных процессов).
