...
* Отдельная кнопка (![](images/cabinetgui_navigationcubehome_as.png){ .ui-icon }) под навигационным кубом позволяет перейти в основное представление, которое можно установить в качестве стандартного вида с помощью настроек, определенных пользователем.
* При переходе на ортогональный вид на всех четырех сторонах навигационного куба вверху справа, вверху слева и внизу по центру появляются треугольные кнопки (![](images/cabinetgui_navigationcubearroworthoright_as_8x12.png){ .ui-icon }), с помощью которых можно повернуть вид на 90° в любом направлении по осям X, Y или Z.
