...
!!! note "Замечание:"
    ...
    Данные страницы, в том числе Тип страницы, копируются в каждом случае изпервогомакроса окна.
