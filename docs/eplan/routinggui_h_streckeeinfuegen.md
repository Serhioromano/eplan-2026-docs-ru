...
1. Выберите следующие команды: Вкладка **Вставить** > группа команд **Помощь в маршрутизации** > **Сегмент маршрутизации**.

![](images/arrow.png) В строке состояния отобразится требование: 'Начальная точка сегмента маршрутизации'.
2. Переместите курсор в область рядом с одним из существующих концов сегмента.

![](images/arrow.png) Конец существующего сегмента окажется захваченным.
3. Разместите начальную точку, щелкнув по захваченной точке.

![](images/arrow.png) В строке состояния отобразится требование: 'Конечная точка сегмента маршрутизации'.
...
![](images/arrow.png) Ручной сегмент маршрутизации будет отображен в пространстве листа.

![](images/arrow.png) Конечная точка последнего сегмента маршрутизации служит начальной точкой следующего сегмента, как у ломаной линии. Эта функция останется активной, пока вы не завершите действие, нажав ++"Esc"++ или выбрав пункт меню **Прервать операцию**.
