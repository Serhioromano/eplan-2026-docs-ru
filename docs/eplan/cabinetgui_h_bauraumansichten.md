...
!!! note "Замечание:"
    ...
    С помощью настройки пользователя [Средняя кнопка мыши](gedviewer_d_einstellungenbenutzerallgemein3d.md) вы задаете действие для средней кнопки мыши — перемещение трехмерной модели в пространстве листа или вращение. Параметр Перемещение и вращение с помощью клавиши ++Shift++ установлен по умолчанию.
