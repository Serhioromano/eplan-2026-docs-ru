...
Или нажмите в строке состояния на кнопку ![](images/statusbar_viewpoint_as.png){ .ui-icon } ( **Повернуть угол зрения**).
