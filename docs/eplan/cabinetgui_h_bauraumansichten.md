...
1. Выберите команды Увеличить фрагмент или Уменьшить фрагмент. (Для этого вам нужно сначала [Настроить ленту](eplan/userinterface_h_menuebandanpassen.md) и присвоить нужную команду определенной пользователем группе команд.)  
...
1. Чтобы повернуть точки наблюдения, используйте [навигационный куб](eplan/cabinetgui_k_navigationswuerfel.md) в правом верхнем углу пространства листа. Или выберите следующие команды: Вкладка Вид > группа команд Точка наблюдения 3D > "Точка наблюдения 3D" (например,  "Точка наблюдения 3D, спереди").  
...
2. Нажмите в групповом поле Цветовые настройки в полях Фон оттенения 1 и Фон оттенения 2 на кнопку [...], чтобы открыть диалоговое окно [Выбор цвета](eplan/mf_d_farbauswahl.md).
...
* [Диалоговое окно "Пространство листа — <Имя проекта>" / диалоговое окно "Выбор 3D-объекта" / диалоговое окно "Отобразить / скрыть 3D-объекты" / диалоговое окно "Выбрать шаблон интерпретации (специфический для проекта)"](eplan/cabinetgui_d_navigator.md)
