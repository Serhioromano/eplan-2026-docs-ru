...
Чтобы сделать видимыми в открытом контуре сохраненные записи данных ЧУ, воспользуйтесь в редакторе контура следующими командами: вкладка Вид > группа команд Запись данных ЧУ > Следующая и Предыдущая.
