...
Доступны только точки определения соединений. Если этот флажок установлен и данный вариант символа используется для кабельных соединений, то этот порядок свойств используется по умолчанию. В [Настройках проекта](eplan/cablegui_r_allpoligeinpolig.md) вы определяете, какой вариант символа используется при размещении точек определения соединений для кабельных соединений. Точки определения соединений для кабельных соединений размещаются при чертеже кабелей / экранирований или при перетаскивании мышью из навигатора кабелей или навигатора соединений в графическом редакторе.

* * *

Конфигурация свойств и настроек отображения

Сама конфигурация свойств с соответствующими настройками отображения выполняется для 3D-размещений изделий на вкладке Трехмерные функции, а для условных обозначений — на вкладке Условное обозначение, а также на вкладках Выводы устройства и Образ контакта. При этом доступны такие же возможности настройки, как и на вкладке [Отображение](eplan/devicetaggui_r_anzeige.md) диалогового окна 'Свойства'.
