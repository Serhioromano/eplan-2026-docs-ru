...
Если необходимо вернуться к прежнему виду порядков свойств, удалите текст из поля ввода. Для этого нажмите кнопку ![](images/all_delete_input_as.png) (Удалить).
