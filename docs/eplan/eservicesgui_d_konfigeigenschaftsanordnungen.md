...
Если необходимо вернуться к прежнему виду порядков свойств, удалите текст из поля ввода. Для этого нажмите кнопку ![](images/all_delete_input_as.png){ .ui-icon } (Удалить).
...
Доступны только точки определения соединений. Если этот флажок установлен и данный вариант символа используется для кабельных соединений, то этот порядок свойств используется по умолчанию. В [Настройках проекта](cablegui_r_allpoligeinpolig.md) вы определяете, какой вариант символа используется при размещении точек определения соединений для кабельных соединений. Точки определения соединений для кабельных соединений размещаются при чертеже кабелей / экранирований или при перетаскивании мышью из навигатора кабелей или навигатора соединений в графическом редакторе.
