...
* Разделитель: Открывает [диалоговое окно Формат: Разделитель](eplan/eservicesgui_d_formattrennzeichen.md), в котором задается форматирование для разделителя в группе форматов.
* Комментарий: Открывает [диалоговое окно Формат: Комментарий](eplan/eservicesgui_d_formatkommentar.md), в котором можно задать комментарий в пределах группы форматов и с помощью которого документируются настройки формата.
* Вычисление: открывает [диалоговое окно Формат: Вычисление](eplan/eservicesgui_d_formatberechnung.md), в котором можно составить расчетную формулу.
