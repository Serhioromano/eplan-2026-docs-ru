...
---|---
![](images/all_arrowrighticon_as.png) |  Свойство можно выбрать двойным щелчком по элементу формата.
![](images/all_stairupicon_as.png) |  С помощью кнопки ![](images/all_stairup_as.png) (Следующая степень) можно перейти от исходного объекта к другим связанным с ним объектам и выбрать косвенные свойства.
![](images/all_stairupmoveright_as.png) |  Можно выбрать свойство (двойным щелчком), а также перейти к другим объектам (с помощью кнопки ![](images/all_stairup_as.png) (Следующая степень)).
![](images/all_propertylist_as.png) |  Группа свойств
...
Нажмите на символ ![](images/all_expand_hierarchy_as.png), чтобы открыть группы свойств более низкого уровня. Если от объекта можно перейти к косвенным свойствам последующих объектов, над полем Навигация активна кнопка ![](images/all_stairup_as.png) (Следующая степень). Щелкните по ней, и снова отобразится первоначальная группировка свойств – теперь это (косвенные) свойства дополнительного объекта! Если выбирается группа форматов, то кнопка ![](images/all_arrowright_as.png) (Переместить направо) активна. В дополнительном диалоговом окне выберите определенное свойство и установите для него форматирование.
...
* Функция: Прямые свойства текущей функции. Текущая функция может быть также связана с начальной функцией, которая при навигации находится с помощью ![](images/all_stairup_as.png) (Следующая степень).
...
* Главная функция: Обеспечивает на вспомогательных функциях доступ к косвенным свойствам главной функции (при помощи ![](images/all_stairup_as.png) (Следующая степень)).
* Главная функция вышестоящего устройства: В случае с вложенными устройствами обеспечивает доступ из подчиненного устройства к свойствам главной функции вышестоящего устройства (при помощи ![](images/all_stairup_as.png) (Следующая степень)). Если главная функция не была обнаружена, выводятся свойства первой вспомогательной функции. Чтобы достичь самого вышестоящего устройства у многократно вложенных устройств, необходим многократный переход через ![](images/all_stairup_as.png) (Следующая степень).
...
* Вышестоящее 3D-размещение изделия: Предоставляет доступ к свойствам вышестоящего 3D-размещения изделия в навигаторе пространства листа (через ![](images/all_stairup_as.png) (Следующая степень)).
* Функциональный текст зоны: Предоставляет доступ к соответствующему функциональному тексту зоны (через ![](images/all_stairup_as.png) (Следующая степень)).
...
* Точка разрыва (обр. эквивалент): Обеспечивает на точках разрыва по типу звезда доступ к косвенным свойствам различных обратных эквивалентов (при помощи ![](images/all_stairup_as.png) (Следующая степень)).
* Точка разрыва (источник): Обеспечивает доступ к свойствам источника точки разрыва (при помощи ![](images/all_stairup_as.png) (Следующая степень)).
* Цель: Свойства целей, которые подсоединены к точке разрыва.
* Соединение: Обеспечивает доступ к косвенным свойствам соединений, через которые закрываются цели на точках разрыва (при помощи ![](images/all_stairup_as.png) (Следующая степень)).
* Страница: Свойства страницы, на которой находится текущая функция.
* Проект: Свойства текущего проекта.
* Разделитель: Открывает [диалоговое окно Формат: Разделитель](eservicesgui_d_formattrennzeichen.md), в котором задается форматирование для разделителя в группе форматов.
* Комментарий: Открывает [диалоговое окно Формат: Комментарий](eservicesgui_d_formatkommentar.md), в котором можно задать комментарий в пределах группы форматов и с помощью которого документируются настройки формата.
...
* Данные сегмента: предоставляет доступ к свойствам вышестоящих сегментов, таким как объекты планирования трубопроводов (с помощью элемента ![](images/all_stairup_as.png) (Следующая степень)).
...
* Проект: Свойства текущего проекта.
* Размещение: В размещенных сегментах предоставляет доступ к свойствам самого размещения (имя страницы, номер столбца и т. д.) и к свойствам страницы через ![](images/all_stairup_as.png) (Следующая степень).
...
Кнопка |  Значение
---|---
![](images/all_stairup_as.png) (Следующая степень) |  Обеспечивает переход от исходного объекта к другим, связанным с ним объектам, а также выбор косвенных свойств.
![](images/all_stairdown_as.png) (Предыдущая ступень) |  Позволяет переходить от косвенно запрошенного объекта обратно к исходному объекту.
