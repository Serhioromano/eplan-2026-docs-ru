...
![](images/arrow.png) Задавать параметры можно для аналогичных направлений подсоединений, которые присутствуют также при составлении схемы соединений.
4. Щелкните по кнопке ++"OK"++.

![](images/arrow.png) Параметры для нового направления подсоединения задаются на всех выводах выделенных устройств.

![](images/arrow.png) В диалоговом окне "Свойства" устройств видны новые направления подсоединения на вкладке **Схема соединений**. Флажок **Локальная схема соединений** установлен.
