...
Посредством операций [Импортировать тексты проекта в словарь](translatedbgui_h_projekttexteimportieren.htm) и [Импортировать тексты изделий в словарь](translatedbgui_h_artikeltexteimportieren.htm) цифры в текстах заменяются заполнителем. При импортировании текст проекта / изделия добавляется в словарь в качестве ключевого слова. Если текст проекта / изделия содержит цифру, в ключевом слове эта цифра будет заменена заполнителем.
...
Посредством операции [Экспортировать список отсутствующих слов](translategui_h_fehlwortexport.htm) цифры в текстах заменяются заполнителем.
