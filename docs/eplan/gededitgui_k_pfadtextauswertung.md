...
!!! note "Замечание:"
    ...
    Определения клеммникови штекеров, а такжевыводы потенциалане оценивают функциональный текст зоны. Используется введенный вручную текст функциональный текст.
