...
С помощью настройки проекта **Распространить функциональный текст зоны на всю зону** (командный путь: **Файл** > **Настройки** > **Проекты** > "Имя проекта" > **Графическая обработка** > **Общее**) можно распространить поиск функционального текста зоны на всю зону.

#### Кабели и экранирования

Для кабелей и экранирований функциональный текст зоны определяется, исходя из графической первой точки определения соединения. Только если нет точки определения соединения, функциональный текст зоны определяется, исходя из точки вставки линии определения кабеля или экранирования.
...
!!! example "Пример:"
    ...
    Для клеммы`X2:1`при поиске от клеммы вверх в той же зоне не найден функциональный текст зоны. После этого выполняется поиск зоны схемы соединений от клеммы вниз и обнаруживается функциональный текст зоны`ABC (1)`. Для клемм`X2:2`и`X2:3`при поиске в той же зоне ни сверху, ни снизу функциональный текст зоны не обнаруживается. Затем выполняется поиск зон слева от клемм снизу вверх, и в зоне клеммы`X2:1`обнаруживается функциональный текст зоны`DEF (2+3)`. Для клеммы`X3:4`при поиске от клеммы вверх не найден функциональный текст зоны`GHI (4)`. Для клемм`X3:5`,`X3:6`и`X4:7`при поиске обнаруживается только лежащий в зоне слева от клемм функциональный текст зоны`JKL (5+6+7)`.
...
!!! note "Замечание:"
    ...
    Описанный здесь отчет в случае клемм и контактов штекера действует аналогичным образом и для экранирований, кабелей и групп соединений.
...
Последовательность поиска для выводов устройства ПЛК и выводов устройства можно инвертировать с помощью настройки проекта **Инвертировать последовательность поиска для выводов устройства ПЛК** (командный путь: **Файл** > **Настройки** > **Проекты** > "Имя проекта" > **Графическая обработка** > **Общее**).
