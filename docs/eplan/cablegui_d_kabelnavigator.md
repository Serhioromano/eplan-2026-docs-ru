...
Собрать кабельные соединения |  Находит все соединения, которые проходят между одними и теми же источником и целью кабеля, но не присвоены ни одному кабелю, и собирает информацию о них в диалоговом окне Обработать кабель в таблице Соединения. С помощью свойства [Соединение: Принадлежность](cablegui_d_kabelbearbeiten.md) вы задаете принадлежность соединений к кабелю.
