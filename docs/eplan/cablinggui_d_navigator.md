...
* Вкладка Соединения > группа команд Топология > Навигатор
* Вы открыли редактор, например графический редактор, редактор рамок и т. д. Вкладка Вид > группа команд Навигаторы > раскрывающаяся кнопка Открыть > Топология
...
---|---  
|  Устройства  
|  Цель (главная функция с видом представления "Топология")  
|  Точка маршрутизации  
|  Сегмент маршрутизации  
|  Дополнительная функция топологии  
