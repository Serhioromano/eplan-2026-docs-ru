...
5. Выберите пункт всплывающего меню Опции размещения, чтобы в диалоговом окне [Опции размещения](eplan/cabinetgui_d_platzieroptionen.md) задать произвольный угол вращения для оси X и / или смещение в направлении X, Y и Z.
