...
Определяемая точка вставки будет видна на курсоре благодаря пересечению координатных осей.
  ...
  5. Выберите пункт всплывающего меню Опции размещения, чтобы в диалоговом окне [Опции размещения](cabinetgui_d_platzieroptionen.htm) задать произвольный угол вращения для оси X и / или смещение в направлении X, Y и Z.
...
[Исходные точки: Принцип](cabinetgui_k_bezugspunkte.htm)
