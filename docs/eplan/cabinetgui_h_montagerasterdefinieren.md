...
![](images/arrow.png) Расположенная под курсором площадь будет автоматически выделена цветом.

![](images/arrow.png) Нулевая точка площади, к которой относятся определенные в диалоговом окне **Монтажная сетка** точки сетки, отображается с системой координат.

![](images/cabinetgui_mountinggrid_select_as.png)
5. Щелкните по нужной площади.

![](images/arrow.png) Монтажная сетка отображается на курсоре с возможностью свободного перемещения.

![](images/arrow.png) На выбранной площади и на размещаемой монтажной сетке отображаются точки захвата.
...
![](images/arrow.png) Монтажная сетка сохраняется в размещении изделия и отображается в пространстве листа на выбранной площади. Функция остается активной, и остальные площади можно снабдить монтажными сетками.

![](images/arrow.png) Для однорядной монтажной сетки отображаются маленькие поперечные линии.
...
![](images/arrow.png) Функциональный элемент можно оптимально разместить на точках пересечения линий монтажной сетки.
