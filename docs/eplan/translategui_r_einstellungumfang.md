...
## Диалоговое окно "Настройки: объем" / вкладка "Объем"

[Вызов диалогового окна:](javascript:void\(0\);)

  * Вы открыли проект. Файл > Настройки > Проекты > "Имя проекта" > Перевод > Объем.
  * Вкладка Инструменты > группа команд Перевод > раскрывающаяся кнопка Перевести > Настройки. Выберите вкладку Объем.



В этом диалоговом окне или на этой вкладке можно выбрать специфические для проекта типы текстов, которые необходимо перевести.
...
При помощи данной кнопки можно преобразовывать тексты, которые исключены из перевода, но для которых добавлен текст перевода, в независимые от языка тексты. После того как вы нажмете кнопку, появится запрос. Доступны следующие опции:
  ...
  * [Нет]: только тексты, для которых вводится пустой текст перевода, преобразуются в независимые от языка тексты. (Пустые тексты перевода могут встречаться, например, в проектах, созданных в старых версиях Eplan (ранее версии 2.0), если там был выбран параметр Переводить при вводе и текст перевода не был найден в словаре.)
