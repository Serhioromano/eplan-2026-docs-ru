...
![](images/potentialbrowsergui_potential_as.png) |  Потенциал
![](images/potentialbrowsergui_signal_as.png) |  Сигнал
![](images/potentialbrowsergui_potentialdefinitionpoint_as.png) |  Размещенная точка определения потенциалов
![](images/potentialbrowsergui_net_as.png) |  Сеть
![](images/potentialbrowsergui_netdefinitionpoint_as.png) |  Размещенная точка определения сети
