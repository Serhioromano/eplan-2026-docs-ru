...
Если флажок установлен, то свойство не выводится, если оно имеет значение, заданное в находящемся ниже поле. Возможно использование [заполнителей](eplan/searchandreplacegui_k_platzhalter.md) типа '*' и '?'.
...
Если флажок установлен, то свойство не выводится, если оно не имеет значения, заданного в находящемся ниже поле. Это означает, что свойство выводится только тогда, когда оно обладает заданным там значением. Возможно использование [заполнителей](eplan/searchandreplacegui_k_platzhalter.md) типа '*' и '?'.
