...
* Выберите в диалоговом окне **Формат** в списке **Доступные элементы формата** группу свойств, и щелкните по символу "+", чтобы открыть группы свойств более низкого уровня. На нижнем слое выделите какую-либо группу и щелкните по кнопке ![](images/all_arrowright_as.png) (Переместить направо).
* Выделите в диалоговом окне **Формат** в списке **Выбранные элементы формата** имеющийся элемент формата и щелкните ![](images/all_edit_as.png) (Обработать).
...
* Выберите в диалоговом окне **Формат** в списке **Доступные элементы формата** группу свойств и нажмите на символ ![](images/all_expand_hierarchy_as.png), чтобы открыть группы свойств более низкого уровня. На нижнем слое выделите какую-либо группу и щелкните по кнопке ![](images/all_arrowright_as.png) (Переместить направо).
* Выделите в диалоговом окне **Формат** в списке **Выбранные элементы формата** имеющийся элемент формата и щелкните ![](images/all_edit_as.png) (Обработать).
