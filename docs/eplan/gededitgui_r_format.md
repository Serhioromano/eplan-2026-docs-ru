...
Такое поведение соответствует выравниванию текстов свойств по центру, как описано в разделе [Свойства отображения: Размещенное свойство](devicetaggui_r_anzeigeeigenschaften.md#Blockzentriert).
