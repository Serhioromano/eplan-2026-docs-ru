...
Здесь доступны уровни иерархии Формат, Рамка текста, Блок выравнивания, Значение / единица измерения, Позиция и Дата / время, открыть которые можно, щелкнув по символу ![](images/all_expand_hierarchy_as.png).
