...
!!! tip "Совет:"
    ...
    В диалоговом окне Обработать клеммникс помощью специальных кнопок можногенерироватьили удалятьвручную созданные мостовые перемычки. Мостовые перемычки можно отдельно генерировать для внутренних и внешних выводов мостовых перемычек.
