...
!!! tip "Совет:"
    ...
    В диалоговом окне Обработать клеммник с помощью специальных кнопок можно генерировать или удалять [вручную созданные мостовые перемычки](terminalgui_k_verwendungbruecken.htm#I_ManuelleStegbruecken). Мостовые перемычки можно отдельно генерировать для внутренних и внешних выводов мостовых перемычек.
