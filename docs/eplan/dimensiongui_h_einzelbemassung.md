...
1. Выберите следующие команды: Вкладка **Вставить** > группа команд **Указание размеров** > **Отдельный размер** или раскрывающийся список **Отдельный размер** > **Произвольное указание размеров**.
