...
Объединение столбцов таблицы на вкладке Функции меняется.
  ...
  3. В диалоговом окне Настройки: Табличная обработка создайте [новую схему](schemeconfig_h_schematabearbeiten.htm) с именем ОУ Fluid-техники ISO 1219-2 и описанием Отображение полного ОУ согласно ISO 1219-2 в отдельных столбцах.
...
!!! note "Замечание:"
    ...
    Флажок строкиСостав ОУустановлен по умолчанию, и его нельзя снять.
