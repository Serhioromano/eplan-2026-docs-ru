...
Косвенные свойства можно выбрать в свойстве формата с помощью навигации посредством кнопок ![](images/all_stairup_as.png) (Следующая степень) и ![](images/all_stairdown_as.png) (Предыдущая степень).
...
Как и в случае со свойствами формата, в открывшемся диалоговом окне Формат устанавливается, какие свойства и разделители будут объединены в свойстве блока. Для функций в этом диалоговом окне доступен элемент формата "Функциональный текст зоны". С помощью кнопки ![](images/all_stairup_as.png) (Следующая степень) вы можете перейти на соответствующий функциональный текст зоны и выбрать его в качестве элемента формата для автоматического функционального текста.
