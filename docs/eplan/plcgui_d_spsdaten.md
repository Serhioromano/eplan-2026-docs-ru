...
* Вкладка Устройства > группа команд ПЛК > Навигатор
...
---|---|---  
|  Проект конфигураций |  с ориентацией на адрес / связано с приводами  
|  Рабочая станция |  с ориентацией на адрес / связано с приводами  
|  ЦПУ |  с ориентацией на адрес  
|  Привод |  связано с приводами  
|  Канал |  с ориентацией на канал  
|  Каркас |  ориентировать по каркасу  
|  Карта ПЛК вставлена в каркас |  ориентировать по каркасу  
|  Карта ПЛК вставлена в каркас и является каркасом |  ориентировать по каркасу  
|  Карта ПЛК вставлена или интегрирована в первичную станцию |  ориентировать по каркасу  
|  Карта ПЛК вставлена в первичную станцию и является каркасом |  ориентировать по каркасу  
|  Каркас не присвоен или недействителен |  ориентировать по каркасу  
...
!!! tip "Совет:"
    ...
    В представлении структуры дерева также отображаютсяизделия, присвоенные карте ПЛК. Если выделено такое изделие, то вместе с ним на странице проекта можно разместить привязанный макрос, перетащив его с помощью мыши. Различные виды отображения данных ПЛК в навигаторе ПЛК позволяют быстро найти требуемыефункциональные элементыс присвоенными изделиями.
...
Адресация |  Этот пункт меню доступен, если выделены выводы устройства ПЛК. Открывает диалоговое окно Адресация выводов устройства ПЛК, в котором выполняется адресация области выводов устройства ПЛК в пределах блока управления ПЛК.  
