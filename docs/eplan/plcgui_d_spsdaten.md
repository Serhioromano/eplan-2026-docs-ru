...
---|---|---
![](images/navplc_configurationproject_as.png) |  Проект конфигураций |  с ориентацией на адрес / связано с приводами
![](images/navplc_station_as.png) |  Рабочая станция |  с ориентацией на адрес / связано с приводами
![](images/navplc_cpu_as.png) |  ЦПУ |  с ориентацией на адрес
![](images/navplc_drive_as.png) |  Привод |  связано с приводами
![](images/plcgui_plcchannel_as.png) |  Канал |  с ориентацией на канал
![](images/navplc_rack_as.png) |  Каркас |  ориентировать по каркасу
![](images/navplc_moduleonrack_as.png) |  Карта ПЛК вставлена в каркас |  ориентировать по каркасу
![](images/navplc_rackonrack_as.png) |  Карта ПЛК вставлена в каркас и является каркасом |  ориентировать по каркасу
![](images/navplc_moduleonheadmodule_as.png) |  Карта ПЛК вставлена или интегрирована в первичную станцию |  ориентировать по каркасу
![](images/navplc_subrackonheadmodule_as.png) |  Карта ПЛК вставлена в первичную станцию и является каркасом |  ориентировать по каркасу
![](images/all_folder_closed.png) |  Каркас не присвоен или недействителен |  ориентировать по каркасу
