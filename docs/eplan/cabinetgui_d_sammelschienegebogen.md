...
Вы открыли проект. Открыты навигатор пространства листа и пространство листа. Вкладка Вставить > группа команд Устройства > ![](images/ribbon_busbarbending_as.png) (Сборная шина (изогнутая)).
