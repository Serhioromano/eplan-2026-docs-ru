...
/PROJECTNAME:C:\Projects\EPLAN\EPLAN_Sample_Project.elkИмпортировать базу данных (словарь):translate
/TYPE:IMPORTTOTRANSDB
/CONVERTER:XTrLanguageDbXmlConverterImpl
/IMPORTFILE:c:\test\TranslationDB_FULL.etd
/LANGUAGE:de_DEУбрать перевод из проекта:translate
