...
2. Выберите требуемую вкладку, например **Электротехника**, **Гидравлика** или **Технология производственных процессов**.
3. Укажите в отдельных полях значения по умолчанию для свойств соединения.
4. Подтвердите ввод.

![](images/arrow.png) Выполняется сохранение значений по умолчанию. При генерировании соединения ему автоматически присваиваются соответствующие значения по умолчанию.
