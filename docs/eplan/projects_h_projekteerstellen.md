...
!!! tip "Совет:"
    ...
    Можно отобразить в свойствах проекта информацию о том, из какого базового проекта создан проект:Выделите проект в навигаторе страниц и выберите пункт всплывающего меню Свойства. Добавьте в виде BackstageСведенияна вкладке Свойствасвойство проекта Проект: Шаблон. Это свойство указывает, на основе какого шаблона (базовый проект или, если он скопирован, исходный проект) создан проект. Для дифференциации помимо имени файла отображается также расширение имени файла.
