...
![](images/arrow.png) В центре сегмента появляются стрелки, расположенные в четырех ортогональных направлениях.
...
![](images/arrow.png) Сегмент трубы / место изгиба перемещается в требуемое положение, прилегающие сегменты изменяются соответственно.
