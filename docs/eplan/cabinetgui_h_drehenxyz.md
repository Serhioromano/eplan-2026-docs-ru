...
![](images/arrow.png) Отображаются точки монтажа и исходные точки, а также их системы координат 3D.

![](images/arrow.png) Оси X, Y и Z систем координат можно использовать в качестве осей вращения.
...
![](images/arrow.png) Ось, ребро или линия, к которой прикоснулся курсор, выделяются светлым.
...
!!! note "Замечание:"
    ...
    В зависимости от настройки область ввода данных либо сразу появляется рядом с курсором, либо после ввода первой цифры. Если область ввода данных должна всегда отображаться в 3-мерном виде при каждом возможном вводе, установите флажок **Всегда отображать область ввода данных (3D)** в настройках пользователя ( **Файл** > **Настройки** > **Пользователь** > **Графическая обработка** > **Область ввода данных**).
