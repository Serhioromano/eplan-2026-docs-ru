...
![](images/arrow.png) На ручных и автоматических сегментах маршрутизации, а также на видимых немаршрутизированных соединениях появятся точки модификации в форме прямоугольных параллелепипедов.
![](images/routing_routingpoint_as.png)

![](images/arrow.png) В строке состояния отобразится требование: "Выбрать сегмент маршрутизации источника".
2. Переместите курсор к какой-нибудь точке, принадлежащей тому сегменту, который вы хотите удалить из трассы маршрутизации.

![](images/arrow.png) Вокруг точки модификации появится красный квадрат в виде точки захвата.
3. Щелчком мыши выберите точку захвата.

![](images/arrow.png) В строке состояния отобразится требование: "Выбрать сегмент маршрутизации цели".
...
![](images/arrow.png) Между точкой сегмента модификации источника, выбранной вначале, и курсором появится белая линия.
