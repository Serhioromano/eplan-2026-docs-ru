...
!!! tip "Совет:"
    ...
    При изменениишланговых соединенийпри помощифункции Изменить маршрутизациюможно также выбрать несколько исходных и целевых сегментов маршрутизации. При этом выбор нескольких сегментов маршрутизации источника осуществляется путем нажатия клавиши пробела.
