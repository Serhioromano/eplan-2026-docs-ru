...
1. В открытом пространстве листа щелкните по кнопке ![](images/cabinetgui_navigationcubehome_as.png) под навигационным кубом, чтобы генерировать заданное в настройках основное представление навигационного куба и пространства листа. Альтернативно можно также использовать комбинацию клавиш [Ctrl] \+ [Alt] \+ [8].
