...
!!! tip "Совет:"
    ...
    В настройке проекта можно указать, чтобы для инкрементального указания размеров отображалось начальное значение. Выберите для этого команды Файл>Настройки>Проекты> "Имя проекта" >Графическая обработка>Указание размерови установите флажок Отобразить начальное значение при инкрементальном указании размеров. Эта настройка также влияет на уже имеющиеся инкрементальные указания размеров.
