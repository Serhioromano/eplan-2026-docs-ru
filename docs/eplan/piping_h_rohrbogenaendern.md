...
### [Переместить колено трубы / место изгиба](javascript:void\(0\);)
...
### [Изменить радиус изгиба](javascript:void\(0\);)
...
### [Вставить дополнительное колено трубы](javascript:void\(0\);)
...
### [Удалить колено трубы / место изгиба](javascript:void\(0\);)
