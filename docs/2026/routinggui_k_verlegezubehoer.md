...
Вставка изделий выполняется при помощи следующих команд: вкладка **Вставить** > группа команд **Устройства** > кнопка ![](images/ribbon_galleryfurther_as.png) (Другие) > **Принадлежности для маршрутизации**. При размещении принадлежности для маршрутизации доступны все стандартные опции пространства листа и диалоговое окно **Опции размещения**.
