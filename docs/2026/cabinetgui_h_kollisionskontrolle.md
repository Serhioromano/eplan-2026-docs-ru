...
1. Выберите следующие команды: Вкладка **Вставить** > группа команд **Параметры** > ![](images/ribbon_collisioncheck_as.png){: .ui-icon } ( **Контроль конфликтов**).
2. Выберите следующие команды: Вкладка **Вставить** > группа команд **Устройства** > ![](images/ribbon_mountingrail_as.png){: .ui-icon } ( **Несущая шина**), и выберите несущую шину для размещения.
...
* [P026011: 3D-графика размещения изделий совпадает с \<x\>](msg/messages_p_026011.md)
