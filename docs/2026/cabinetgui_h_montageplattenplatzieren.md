...
1. Выберите следующие команды: Вкладка **Вставить** > группа команд **Устройства** > ![](images/ribbon_mountingpanel_as.png){: .ui-icon } ( **Монтажная плата**).
...
1. Выберите следующие команды: Вкладка **Вставить** > группа команд **Устройства** > ![](images/ribbon_freemountingpanel_as.png){: .ui-icon } ( **Произвольная монтажная плата**).
