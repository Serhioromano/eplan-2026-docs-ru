...
С помощью кнопки ![](images/all_selectfile_as.png){: .ui-icon } откройте диалоговое окно для выбора файла. Там вы можете выбрать уже имеющиеся имена проектов и затем изменить их.
